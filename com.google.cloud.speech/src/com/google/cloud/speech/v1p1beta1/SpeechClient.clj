(ns com.google.cloud.speech.v1p1beta1.SpeechClient
...
(defn *create
  ...
  settings - `com.google.cloud.speech.v1p1beta1.SpeechSettings`

  returns: `com.google.cloud.speech.v1p1beta1.SpeechClient`

  throws: java.io.IOException"
  (^com.google.cloud.speech.v1p1beta1.SpeechClient [^com.google.cloud.speech.v1p1beta1.SpeechSettings settings]
...
(defn long-running-recognize-async
  ...
  config - *Required* Provides information to the recognizer that specifies how to process the request. - `com.google.cloud.speech.v1p1beta1.RecognitionConfig`
  audio - *Required* The audio data to be recognized. - `com.google.cloud.speech.v1p1beta1.RecognitionAudio`

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse,com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^SpeechClient this ^com.google.cloud.speech.v1p1beta1.RecognitionConfig config ^com.google.cloud.speech.v1p1beta1.RecognitionAudio audio]
    (-> this (.longRunningRecognizeAsync config audio)))
  ([^SpeechClient this ^com.google.cloud.speech.v1p1beta1.LongRunningRecognizeRequest request]
    (-> this (.longRunningRecognizeAsync request))))

(defn get-settings
  "returns: `com.google.cloud.speech.v1p1beta1.SpeechSettings`"
  (^com.google.cloud.speech.v1p1beta1.SpeechSettings [^SpeechClient this]
    (-> this (.getSettings))))
...
(defn recognize
  ...
  returns: `com.google.cloud.speech.v1p1beta1.RecognizeResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.speech.v1p1beta1.RecognizeResponse [^SpeechClient this ^com.google.cloud.speech.v1p1beta1.RecognitionConfig config ^com.google.cloud.speech.v1p1beta1.RecognitionAudio audio]
    (-> this (.recognize config audio)))
  (^com.google.cloud.speech.v1p1beta1.RecognizeResponse [^SpeechClient this ^com.google.cloud.speech.v1p1beta1.RecognizeRequest request]
