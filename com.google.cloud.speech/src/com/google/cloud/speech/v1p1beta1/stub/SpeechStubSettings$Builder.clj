(ns com.google.cloud.speech.v1p1beta1.stub.SpeechStubSettings$Builder
  "Builder for SpeechStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.speech.v1p1beta1.stub SpeechStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.speech.v1p1beta1.stub.SpeechStubSettings$Builder [^SpeechStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn long-running-recognize-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.speech.v1p1beta1.LongRunningRecognizeRequest,com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse,com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata>`"
...
(defn build
  ...
  (^com.google.cloud.speech.v1p1beta1.stub.SpeechStubSettings [^SpeechStubSettings$Builder this]
    (-> this (.build))))
