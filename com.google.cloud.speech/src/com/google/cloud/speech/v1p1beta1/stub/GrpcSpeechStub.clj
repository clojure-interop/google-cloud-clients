(ns com.google.cloud.speech.v1p1beta1.stub.GrpcSpeechStub
...
(defn *create
  ...
  returns: `com.google.cloud.speech.v1p1beta1.stub.GrpcSpeechStub`

  throws: java.io.IOException"
  (^com.google.cloud.speech.v1p1beta1.stub.GrpcSpeechStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcSpeechStub/create client-context callable-factory))
  (^com.google.cloud.speech.v1p1beta1.stub.GrpcSpeechStub [^com.google.cloud.speech.v1p1beta1.stub.SpeechStubSettings settings]
