(ns com.google.cloud.spanner.v1.stub.SpannerStubSettings$Builder
  "Builder for SpannerStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.spanner.v1.stub SpannerStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.spanner.v1.stub.SpannerStubSettings$Builder [^SpannerStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn execute-batch-dml-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^SpannerStubSettings$Builder this]
...
(defn list-sessions-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^SpannerStubSettings$Builder this]
...
(defn build
  ...
  (^com.google.cloud.spanner.v1.stub.SpannerStubSettings [^SpannerStubSettings$Builder this]
    (-> this (.build))))
...
(defn execute-streaming-sql-settings
  ...
  (^com.google.api.gax.rpc.ServerStreamingCallSettings.Builder [^SpannerStubSettings$Builder this]
...
(defn unary-method-settings-builders
  ...
  (^com.google.common.collect.ImmutableList [^SpannerStubSettings$Builder this]
