(ns com.google.cloud.texttospeech.v1beta1.TextToSpeechClient
...
(defn *create
  ...
  settings - `com.google.cloud.texttospeech.v1beta1.TextToSpeechSettings`

  returns: `com.google.cloud.texttospeech.v1beta1.TextToSpeechClient`

  throws: java.io.IOException"
  (^com.google.cloud.texttospeech.v1beta1.TextToSpeechClient [^com.google.cloud.texttospeech.v1beta1.TextToSpeechSettings settings]
...
(defn synthesize-speech-callable
  ...
  returns: `com.google.api.gax.rpc.UnaryCallable<com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest,com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechResponse>`"
...
(defn get-settings
  ...
  (^com.google.cloud.texttospeech.v1beta1.TextToSpeechSettings [^TextToSpeechClient this]
    (-> this (.getSettings))))
...
(defn list-voices-callable
  ...
  returns: `com.google.api.gax.rpc.UnaryCallable<com.google.cloud.texttospeech.v1beta1.ListVoicesRequest,com.google.cloud.texttospeech.v1beta1.ListVoicesResponse>`"
  (^com.google.api.gax.rpc.UnaryCallable [^TextToSpeechClient this]
    (-> this (.listVoicesCallable))))

(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.texttospeech.v1beta1.stub.TextToSpeechStub`"
...
(defn list-voices
  ...
  returns: `com.google.cloud.texttospeech.v1beta1.ListVoicesResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.texttospeech.v1beta1.ListVoicesResponse [^TextToSpeechClient this ^java.lang.String language-code]
...
(defn synthesize-speech
  ...
  input - Required. The Synthesizer requires either plain text or SSML as input. - `com.google.cloud.texttospeech.v1beta1.SynthesisInput`
  voice - Required. The desired voice of the synthesized audio. - `com.google.cloud.texttospeech.v1beta1.VoiceSelectionParams`
  audio-config - Required. The configuration of the synthesized audio. - `com.google.cloud.texttospeech.v1beta1.AudioConfig`

  returns: `com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechResponse [^TextToSpeechClient this ^com.google.cloud.texttospeech.v1beta1.SynthesisInput input ^com.google.cloud.texttospeech.v1beta1.VoiceSelectionParams voice ^com.google.cloud.texttospeech.v1beta1.AudioConfig audio-config]
    (-> this (.synthesizeSpeech input voice audio-config)))
  (^com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechResponse [^TextToSpeechClient this ^com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest request]
