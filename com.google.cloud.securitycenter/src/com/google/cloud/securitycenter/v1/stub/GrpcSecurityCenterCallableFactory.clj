(ns com.google.cloud.securitycenter.v1.stub.GrpcSecurityCenterCallableFactory
  "gRPC callable factory implementation for Cloud Security Command Center API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.securitycenter.v1.stub GrpcSecurityCenterCallableFactory]))
