(ns com.google.cloud.redis.v1.stub.GrpcCloudRedisStub
...
(defn *create
  ...
  returns: `com.google.cloud.redis.v1.stub.GrpcCloudRedisStub`

  throws: java.io.IOException"
  (^com.google.cloud.redis.v1.stub.GrpcCloudRedisStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcCloudRedisStub/create client-context callable-factory))
  (^com.google.cloud.redis.v1.stub.GrpcCloudRedisStub [^com.google.cloud.redis.v1.stub.CloudRedisStubSettings settings]
