(ns com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ImageAnnotatorStubSettings/newBuilder client-context))
  (^com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStubSettings$Builder []
    (ImageAnnotatorStubSettings/newBuilder )))
...
(defn to-builder
  ...
  returns: `com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStubSettings$Builder`"
  (^com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStubSettings$Builder [^ImageAnnotatorStubSettings this]
    (-> this (.toBuilder))))
