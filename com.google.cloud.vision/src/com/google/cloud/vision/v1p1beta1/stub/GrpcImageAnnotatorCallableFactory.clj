(ns com.google.cloud.vision.v1p1beta1.stub.GrpcImageAnnotatorCallableFactory
  "gRPC callable factory implementation for Google Cloud Vision API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.vision.v1p1beta1.stub GrpcImageAnnotatorCallableFactory]))
