(ns com.google.cloud.vision.v1p4beta1.ProductSearchClient
  "Service Description: Manages Products and ProductSets of reference images for use in product
  search. It uses the following resource model:

  - The API has a collection of [ProductSet][google.cloud.vision.v1p4beta1.ProductSet]
  ...
  - The API has a collection of [Product][google.cloud.vision.v1p4beta1.Product] resources,
...
(defn *create
  ...
  settings - `com.google.cloud.vision.v1p4beta1.ProductSearchSettings`

  returns: `com.google.cloud.vision.v1p4beta1.ProductSearchClient`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p4beta1.ProductSearchClient [^com.google.cloud.vision.v1p4beta1.ProductSearchSettings settings]
...
(defn get-reference-image
  ...
  name - The resource name of the ReferenceImage to get. Format is: `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID/referenceImages/IMAGE_ID`. - `com.google.cloud.vision.v1p4beta1.ReferenceImageName`

  returns: `com.google.cloud.vision.v1p4beta1.ReferenceImage`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ReferenceImage [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ReferenceImageName name]
...
(defn remove-product-from-product-set
  ...
  name - The resource name for the ProductSet to modify. Format is: `projects/PROJECT_ID/locations/LOC_ID/productSets/PRODUCT_SET_ID` - `com.google.cloud.vision.v1p4beta1.ProductSetName`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductSetName name ^java.lang.String product]
    (-> this (.removeProductFromProductSet name product)))
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.RemoveProductFromProductSetRequest request]
...
(defn delete-product
  ...
  name - Resource name of product to delete. Format is: `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID` - `com.google.cloud.vision.v1p4beta1.ProductName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductName name]
...
(defn delete-product-set
  ...
  name - Resource name of the ProductSet to delete. Format is: `projects/PROJECT_ID/locations/LOC_ID/productSets/PRODUCT_SET_ID` - `com.google.cloud.vision.v1p4beta1.ProductSetName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductSetName name]
...
(defn add-product-to-product-set
  ...
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.AddProductToProductSetRequest request]
...
(defn get-settings
  ...
  (^com.google.cloud.vision.v1p4beta1.ProductSearchSettings [^ProductSearchClient this]
    (-> this (.getSettings))))
...
(defn list-products-in-product-set
  ...
  name - The ProductSet resource for which to retrieve Products. Format is: `projects/PROJECT_ID/locations/LOC_ID/productSets/PRODUCT_SET_ID` - `com.google.cloud.vision.v1p4beta1.ProductSetName`

  returns: `com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListProductsInProductSetPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListProductsInProductSetPagedResponse [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductSetName name]
...
(defn get-product-set
  ...
  name - Resource name of the ProductSet to get. Format is: `projects/PROJECT_ID/locations/LOG_ID/productSets/PRODUCT_SET_ID` - `com.google.cloud.vision.v1p4beta1.ProductSetName`

  returns: `com.google.cloud.vision.v1p4beta1.ProductSet`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSet [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductSetName name]
...
(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.vision.v1p4beta1.stub.ProductSearchStub`"
  ([^ProductSearchClient this]
    (-> this (.getStub))))
...
(defn delete-reference-image
  ...
  name - The resource name of the reference image to delete. Format is: `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID/referenceImages/IMAGE_ID` - `com.google.cloud.vision.v1p4beta1.ReferenceImageName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ReferenceImageName name]
...
(defn list-product-sets
  ...
  parent - The project from which ProductSets should be listed. Format is `projects/PROJECT_ID/locations/LOC_ID`. - `com.google.cloud.vision.v1p4beta1.LocationName`

  returns: `com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListProductSetsPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListProductSetsPagedResponse [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.LocationName parent]
...
(defn update-product
  ...
  product - The Product resource which replaces the one on the server. product.name is immutable. - `com.google.cloud.vision.v1p4beta1.Product`
  ...
  returns: `com.google.cloud.vision.v1p4beta1.Product`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.Product [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.Product product ^com.google.protobuf.FieldMask update-mask]
    (-> this (.updateProduct product update-mask)))
  (^com.google.cloud.vision.v1p4beta1.Product [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.UpdateProductRequest request]
...
(defn list-reference-images
  ...
  parent - Resource name of the product containing the reference images. Format is `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID`. - `com.google.cloud.vision.v1p4beta1.ProductName`

  returns: `com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListReferenceImagesPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListReferenceImagesPagedResponse [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductName parent]
...
(defn create-product
  ...
  parent - The project in which the Product should be created. Format is `projects/PROJECT_ID/locations/LOC_ID`. - `com.google.cloud.vision.v1p4beta1.LocationName`
  product - The product to create. - `com.google.cloud.vision.v1p4beta1.Product`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.Product [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.LocationName parent ^com.google.cloud.vision.v1p4beta1.Product product ^java.lang.String product-id]
    (-> this (.createProduct parent product product-id)))
  (^com.google.cloud.vision.v1p4beta1.Product [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.CreateProductRequest request]
...
(defn import-product-sets-async
  ...
  parent - The project in which the ProductSets should be imported. Format is `projects/PROJECT_ID/locations/LOC_ID`. - `com.google.cloud.vision.v1p4beta1.LocationName`
  input-config - The input content for the list of requests. - `com.google.cloud.vision.v1p4beta1.ImportProductSetsInputConfig`

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.vision.v1p4beta1.ImportProductSetsResponse,com.google.cloud.vision.v1p4beta1.BatchOperationMetadata>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.LocationName parent ^com.google.cloud.vision.v1p4beta1.ImportProductSetsInputConfig input-config]
    (-> this (.importProductSetsAsync parent input-config)))
  ([^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ImportProductSetsRequest request]
...
(defn update-product-set
  ...
  product-set - The ProductSet resource which replaces the one on the server. - `com.google.cloud.vision.v1p4beta1.ProductSet`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSet [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductSet product-set ^com.google.protobuf.FieldMask update-mask]
    (-> this (.updateProductSet product-set update-mask)))
  (^com.google.cloud.vision.v1p4beta1.ProductSet [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.UpdateProductSetRequest request]
...
(defn list-products
  ...
  parent - The project OR ProductSet from which Products should be listed. Format: `projects/PROJECT_ID/locations/LOC_ID` - `com.google.cloud.vision.v1p4beta1.LocationName`

  returns: `com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListProductsPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSearchClient$ListProductsPagedResponse [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.LocationName parent]
...
(defn create-product-set
  ...
  parent - The project in which the ProductSet should be created. Format is `projects/PROJECT_ID/locations/LOC_ID`. - `com.google.cloud.vision.v1p4beta1.LocationName`
  product-set - The ProductSet to create. - `com.google.cloud.vision.v1p4beta1.ProductSet`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ProductSet [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.LocationName parent ^com.google.cloud.vision.v1p4beta1.ProductSet product-set ^java.lang.String product-set-id]
    (-> this (.createProductSet parent product-set product-set-id)))
  (^com.google.cloud.vision.v1p4beta1.ProductSet [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.CreateProductSetRequest request]
...
(defn create-reference-image
  ...
  parent - Resource name of the product in which to create the reference image. Format is `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID`. - `com.google.cloud.vision.v1p4beta1.ProductName`
  reference-image - The reference image to create. If an image ID is specified, it is ignored. - `com.google.cloud.vision.v1p4beta1.ReferenceImage`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.ReferenceImage [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductName parent ^com.google.cloud.vision.v1p4beta1.ReferenceImage reference-image ^java.lang.String reference-image-id]
    (-> this (.createReferenceImage parent reference-image reference-image-id)))
  (^com.google.cloud.vision.v1p4beta1.ReferenceImage [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.CreateReferenceImageRequest request]
...
(defn get-product
  ...
  name - Resource name of the Product to get. Format is: `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID` - `com.google.cloud.vision.v1p4beta1.ProductName`

  returns: `com.google.cloud.vision.v1p4beta1.Product`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p4beta1.Product [^ProductSearchClient this ^com.google.cloud.vision.v1p4beta1.ProductName name]
