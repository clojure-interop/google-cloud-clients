(ns com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ImageAnnotatorSettings/newBuilder client-context))
  (^com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings$Builder []
    (ImageAnnotatorSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.vision.v1p4beta1.stub.ImageAnnotatorStubSettings`

  returns: `com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings [^com.google.cloud.vision.v1p4beta1.stub.ImageAnnotatorStubSettings stub]
...
(defn batch-annotate-images-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.vision.v1p4beta1.BatchAnnotateImagesRequest,com.google.cloud.vision.v1p4beta1.BatchAnnotateImagesResponse>`"
...
(defn batch-annotate-files-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesRequest,com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesResponse>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^ImageAnnotatorSettings this]
...
(defn async-batch-annotate-images-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateImagesRequest,com.google.longrunning.Operation>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^ImageAnnotatorSettings this]
...
(defn async-batch-annotate-images-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateImagesRequest,com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateImagesResponse,com.google.cloud.vision.v1p4beta1.OperationMetadata>`"
...
(defn async-batch-annotate-files-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateFilesRequest,com.google.longrunning.Operation>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^ImageAnnotatorSettings this]
...
(defn async-batch-annotate-files-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateFilesRequest,com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateFilesResponse,com.google.cloud.vision.v1p4beta1.OperationMetadata>`"
  ([^ImageAnnotatorSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings$Builder`"
  (^com.google.cloud.vision.v1p4beta1.ImageAnnotatorSettings$Builder [^ImageAnnotatorSettings this]
    (-> this (.toBuilder))))
