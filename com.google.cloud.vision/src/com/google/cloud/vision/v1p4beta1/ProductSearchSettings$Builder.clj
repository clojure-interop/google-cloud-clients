(ns com.google.cloud.vision.v1p4beta1.ProductSearchSettings$Builder
  "Builder for ProductSearchSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.vision.v1p4beta1 ProductSearchSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.vision.v1p4beta1.ProductSearchSettings$Builder [^ProductSearchSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  ...
  (^com.google.cloud.vision.v1p4beta1.ProductSearchSettings [^ProductSearchSettings$Builder this]
    (-> this (.build))))
...
(defn get-stub-settings-builder
  ...
  (^com.google.cloud.vision.v1p4beta1.stub.ProductSearchStubSettings$Builder [^ProductSearchSettings$Builder this]
...
(defn import-product-sets-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.vision.v1p4beta1.ImportProductSetsRequest,com.google.cloud.vision.v1p4beta1.ImportProductSetsResponse,com.google.cloud.vision.v1p4beta1.BatchOperationMetadata>`"
