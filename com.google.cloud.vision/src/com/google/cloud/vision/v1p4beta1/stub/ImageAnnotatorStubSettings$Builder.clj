...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.vision.v1p4beta1.stub.ImageAnnotatorStubSettings$Builder [^ImageAnnotatorStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  "returns: `com.google.cloud.vision.v1p4beta1.stub.ImageAnnotatorStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p4beta1.stub.ImageAnnotatorStubSettings [^ImageAnnotatorStubSettings$Builder this]
    (-> this (.build))))
...
(defn async-batch-annotate-files-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateFilesRequest,com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateFilesResponse,com.google.cloud.vision.v1p4beta1.OperationMetadata>`"
...
(defn async-batch-annotate-images-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateImagesRequest,com.google.cloud.vision.v1p4beta1.AsyncBatchAnnotateImagesResponse,com.google.cloud.vision.v1p4beta1.OperationMetadata>`"
  ([^ImageAnnotatorStubSettings$Builder this]
