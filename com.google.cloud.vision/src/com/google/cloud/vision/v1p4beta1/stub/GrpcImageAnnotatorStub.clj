(ns com.google.cloud.vision.v1p4beta1.stub.GrpcImageAnnotatorStub
  "gRPC stub implementation for Cloud Vision API.

  This class is for advanced usage and reflects the underlying API directly."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.vision.v1p4beta1.stub GrpcImageAnnotatorStub]))

(defn *create
  "client-context - `com.google.api.gax.rpc.ClientContext`
  callable-factory - `com.google.api.gax.grpc.GrpcStubCallableFactory`

  returns: `com.google.cloud.vision.v1p4beta1.stub.GrpcImageAnnotatorStub`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p4beta1.stub.GrpcImageAnnotatorStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcImageAnnotatorStub/create client-context callable-factory))
  (^com.google.cloud.vision.v1p4beta1.stub.GrpcImageAnnotatorStub [^com.google.cloud.vision.v1p4beta1.stub.ImageAnnotatorStubSettings settings]
