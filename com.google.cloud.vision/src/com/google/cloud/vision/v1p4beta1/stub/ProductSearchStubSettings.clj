(ns com.google.cloud.vision.v1p4beta1.stub.ProductSearchStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.vision.v1p4beta1.stub.ProductSearchStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
...
(defn import-product-sets-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1p4beta1.ImportProductSetsRequest,com.google.cloud.vision.v1p4beta1.ImportProductSetsResponse,com.google.cloud.vision.v1p4beta1.BatchOperationMetadata>`"
  ([^ProductSearchStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.vision.v1p4beta1.stub.ProductSearchStubSettings$Builder`"
  (^com.google.cloud.vision.v1p4beta1.stub.ProductSearchStubSettings$Builder [^ProductSearchStubSettings this]
    (-> this (.toBuilder))))
