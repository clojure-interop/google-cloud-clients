(ns com.google.cloud.vision.v1p2beta1.stub.ImageAnnotatorStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.vision.v1p2beta1.stub.ImageAnnotatorStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ImageAnnotatorStubSettings/newBuilder client-context))
  (^com.google.cloud.vision.v1p2beta1.stub.ImageAnnotatorStubSettings$Builder []
    (ImageAnnotatorStubSettings/newBuilder )))
...
(defn async-batch-annotate-files-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequest,com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesResponse,com.google.cloud.vision.v1p2beta1.OperationMetadata>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.vision.v1p2beta1.stub.ImageAnnotatorStubSettings$Builder`"
  (^com.google.cloud.vision.v1p2beta1.stub.ImageAnnotatorStubSettings$Builder [^ImageAnnotatorStubSettings this]
    (-> this (.toBuilder))))
