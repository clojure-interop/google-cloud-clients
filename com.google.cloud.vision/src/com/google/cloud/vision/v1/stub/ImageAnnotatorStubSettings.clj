(ns com.google.cloud.vision.v1.stub.ImageAnnotatorStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.vision.v1.stub.ImageAnnotatorStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ImageAnnotatorStubSettings/newBuilder client-context))
  (^com.google.cloud.vision.v1.stub.ImageAnnotatorStubSettings$Builder []
    (ImageAnnotatorStubSettings/newBuilder )))
...
(defn async-batch-annotate-images-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest,com.google.cloud.vision.v1.AsyncBatchAnnotateImagesResponse,com.google.cloud.vision.v1.OperationMetadata>`"
...
(defn async-batch-annotate-files-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest,com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponse,com.google.cloud.vision.v1.OperationMetadata>`"
  ([^ImageAnnotatorStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.vision.v1.stub.ImageAnnotatorStubSettings$Builder`"
  (^com.google.cloud.vision.v1.stub.ImageAnnotatorStubSettings$Builder [^ImageAnnotatorStubSettings this]
    (-> this (.toBuilder))))
