(ns com.google.cloud.vision.v1p3beta1.ImageAnnotatorClient
...
(defn *create
  ...
  settings - `com.google.cloud.vision.v1p3beta1.ImageAnnotatorSettings`

  returns: `com.google.cloud.vision.v1p3beta1.ImageAnnotatorClient`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p3beta1.ImageAnnotatorClient [^com.google.cloud.vision.v1p3beta1.ImageAnnotatorSettings settings]
    (ImageAnnotatorClient/create settings))
  (^com.google.cloud.vision.v1p3beta1.ImageAnnotatorClient []
...
(defn async-batch-annotate-files-async
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesResponse,com.google.cloud.vision.v1p3beta1.OperationMetadata>`
...
(defn get-settings
  ...
  (^com.google.cloud.vision.v1p3beta1.ImageAnnotatorSettings [^ImageAnnotatorClient this]
    (-> this (.getSettings))))
...
(defn batch-annotate-images
  ...
  returns: `com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesResponse [^ImageAnnotatorClient this ^java.util.List requests]
