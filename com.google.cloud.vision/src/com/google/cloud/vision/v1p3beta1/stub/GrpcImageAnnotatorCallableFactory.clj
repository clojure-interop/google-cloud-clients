(ns com.google.cloud.vision.v1p3beta1.stub.GrpcImageAnnotatorCallableFactory
  "gRPC callable factory implementation for Cloud Vision API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.vision.v1p3beta1.stub GrpcImageAnnotatorCallableFactory]))
