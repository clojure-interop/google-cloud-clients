(ns com.google.cloud.vision.v1p3beta1.stub.GrpcProductSearchStub
  "gRPC stub implementation for Cloud Vision API.

  This class is for advanced usage and reflects the underlying API directly."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.vision.v1p3beta1.stub GrpcProductSearchStub]))

(defn *create
  "client-context - `com.google.api.gax.rpc.ClientContext`
  callable-factory - `com.google.api.gax.grpc.GrpcStubCallableFactory`

  returns: `com.google.cloud.vision.v1p3beta1.stub.GrpcProductSearchStub`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p3beta1.stub.GrpcProductSearchStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcProductSearchStub/create client-context callable-factory))
  (^com.google.cloud.vision.v1p3beta1.stub.GrpcProductSearchStub [^com.google.cloud.vision.v1p3beta1.stub.ProductSearchStubSettings settings]
