(ns com.google.cloud.vision.v1p3beta1.ProductSearchSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.vision.v1p3beta1.ProductSearchSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ProductSearchSettings/newBuilder client-context))
  (^com.google.cloud.vision.v1p3beta1.ProductSearchSettings$Builder []
    (ProductSearchSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.vision.v1p3beta1.stub.ProductSearchStubSettings`

  returns: `com.google.cloud.vision.v1p3beta1.ProductSearchSettings`

  throws: java.io.IOException"
  (^com.google.cloud.vision.v1p3beta1.ProductSearchSettings [^com.google.cloud.vision.v1p3beta1.stub.ProductSearchStubSettings stub]
...
(defn import-product-sets-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.vision.v1p3beta1.ImportProductSetsRequest,com.google.cloud.vision.v1p3beta1.ImportProductSetsResponse,com.google.cloud.vision.v1p3beta1.BatchOperationMetadata>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.vision.v1p3beta1.ProductSearchSettings$Builder`"
  (^com.google.cloud.vision.v1p3beta1.ProductSearchSettings$Builder [^ProductSearchSettings this]
    (-> this (.toBuilder))))
