(ns com.google.cloud.websecurityscanner.v1beta.stub.GrpcWebSecurityScannerCallableFactory
  "gRPC callable factory implementation for Web Security Scanner API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.websecurityscanner.v1beta.stub GrpcWebSecurityScannerCallableFactory]))
