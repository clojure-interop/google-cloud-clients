(ns com.google.cloud.websecurityscanner.v1beta.stub.WebSecurityScannerStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.websecurityscanner.v1beta.stub.WebSecurityScannerStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (WebSecurityScannerStubSettings/newBuilder client-context))
  (^com.google.cloud.websecurityscanner.v1beta.stub.WebSecurityScannerStubSettings$Builder []
    (WebSecurityScannerStubSettings/newBuilder )))
...
(defn to-builder
  ...
  returns: `com.google.cloud.websecurityscanner.v1beta.stub.WebSecurityScannerStubSettings$Builder`"
  (^com.google.cloud.websecurityscanner.v1beta.stub.WebSecurityScannerStubSettings$Builder [^WebSecurityScannerStubSettings this]
    (-> this (.toBuilder))))
