(ns com.google.cloud.tasks.v2beta3.CloudTasksClient
...
(defn *create
  ...
  settings - `com.google.cloud.tasks.v2beta3.CloudTasksSettings`

  returns: `com.google.cloud.tasks.v2beta3.CloudTasksClient`

  throws: java.io.IOException"
  (^com.google.cloud.tasks.v2beta3.CloudTasksClient [^com.google.cloud.tasks.v2beta3.CloudTasksSettings settings]
    (CloudTasksClient/create settings))
  (^com.google.cloud.tasks.v2beta3.CloudTasksClient []
...
(defn list-tasks-paged-callable
  "Lists the tasks in a queue.
   ...
   [response_view][google.cloud.tasks.v2beta3.ListTasksRequest.response_view] controls the subset
...
(defn set-iam-policy
  ...
  resource - REQUIRED: The resource for which the policy is being specified. See the operation documentation for the appropriate value for this field. - `com.google.cloud.tasks.v2beta3.QueueName`
  ...
  (^com.google.iam.v1.Policy [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.QueueName resource ^com.google.iam.v1.Policy policy]
...
(defn pause-queue
  "Pauses the queue.
   ...
   via [ResumeQueue][google.cloud.tasks.v2beta3.CloudTasks.ResumeQueue]. Tasks can still be added
  ...
  name - Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2beta3.QueueName`

  returns: `com.google.cloud.tasks.v2beta3.Queue`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2beta3.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.QueueName name]
...
(defn list-queues
  ...
  parent - Required. The location name. For example: `projects/PROJECT_ID/locations/LOCATION_ID` - `com.google.cloud.tasks.v2beta3.LocationName`

  returns: `com.google.cloud.tasks.v2beta3.CloudTasksClient$ListQueuesPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2beta3.CloudTasksClient$ListQueuesPagedResponse [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.LocationName parent]
    (-> this (.listQueues parent))))

(defn get-settings
  "returns: `com.google.cloud.tasks.v2beta3.CloudTasksSettings`"
  (^com.google.cloud.tasks.v2beta3.CloudTasksSettings [^CloudTasksClient this]
    (-> this (.getSettings))))
...
(defn resume-queue
  "Resume a queue.
   ...
   [DISABLED][google.cloud.tasks.v2beta3.Queue.State.DISABLED]. The state of a queue is stored in
   the queue's [state][google.cloud.tasks.v2beta3.Queue.state]; after calling this method it will
   be set to [RUNNING][google.cloud.tasks.v2beta3.Queue.State.RUNNING].
...
(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.tasks.v2beta3.stub.CloudTasksStub`"
...
(defn update-queue
  ...
  queue - Required. The queue to create or update. The queue's [name][google.cloud.tasks.v2beta3.Queue.name] must be specified. Output only fields cannot be modified using UpdateQueue. Any value specified for an output only field will be ignored. The queue's [name][google.cloud.tasks.v2beta3.Queue.name] cannot be changed. - `com.google.cloud.tasks.v2beta3.Queue`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2beta3.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.Queue queue ^com.google.protobuf.FieldMask update-mask]
    (-> this (.updateQueue queue update-mask)))
  (^com.google.cloud.tasks.v2beta3.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.UpdateQueueRequest request]
...
(defn run-task
  "Forces a task to run now.
   ...
   running, the queue has reached its [RateLimits][google.cloud.tasks.v2beta3.RateLimits] or is
   [PAUSED][google.cloud.tasks.v2beta3.Queue.State.PAUSED].

   This command is meant to be used for manual debugging. For example,
   [RunTask][google.cloud.tasks.v2beta3.CloudTasks.RunTask] can be used to retry a failed task
   ...
   will be reset to the time that [RunTask][google.cloud.tasks.v2beta3.CloudTasks.RunTask] was
  ...
  name - Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID` - `com.google.cloud.tasks.v2beta3.TaskName`

  returns: `com.google.cloud.tasks.v2beta3.Task`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2beta3.Task [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.TaskName name]
    (-> this (.runTask name))))
...
(defn create-queue
  ...
  parent - Required. The location name in which the queue will be created. For example: `projects/PROJECT_ID/locations/LOCATION_ID` The list of allowed locations can be obtained by calling Cloud Tasks' implementation of [ListLocations][google.cloud.location.Locations.ListLocations]. - `com.google.cloud.tasks.v2beta3.LocationName`
  queue - Required. The queue to create. [Queue's name][google.cloud.tasks.v2beta3.Queue.name] cannot be the same as an existing queue. - `com.google.cloud.tasks.v2beta3.Queue`

  returns: `com.google.cloud.tasks.v2beta3.Queue`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2beta3.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.LocationName parent ^com.google.cloud.tasks.v2beta3.Queue queue]
    (-> this (.createQueue parent queue)))
  (^com.google.cloud.tasks.v2beta3.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.CreateQueueRequest request]
...
(defn delete-queue
  ...
  name - Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2beta3.QueueName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.QueueName name]
...
(defn delete-task
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.TaskName name]
...
(defn get-iam-policy
  ...
  resource - REQUIRED: The resource for which the policy is being requested. See the operation documentation for the appropriate value for this field. - `com.google.cloud.tasks.v2beta3.QueueName`

  returns: `com.google.iam.v1.Policy`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.iam.v1.Policy [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.QueueName resource]
...
(defn get-queue
  ...
  name - Required. The resource name of the queue. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2beta3.QueueName`
...
(defn list-tasks
  ...
  parent - Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2beta3.QueueName`

  returns: `com.google.cloud.tasks.v2beta3.CloudTasksClient$ListTasksPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2beta3.CloudTasksClient$ListTasksPagedResponse [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.QueueName parent]
...
(defn test-iam-permissions
  ...
  resource - REQUIRED: The resource for which the policy detail is being requested. See the operation documentation for the appropriate value for this field. - `com.google.cloud.tasks.v2beta3.QueueName`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.iam.v1.TestIamPermissionsResponse [^CloudTasksClient this ^com.google.cloud.tasks.v2beta3.QueueName resource ^java.util.List permissions]
