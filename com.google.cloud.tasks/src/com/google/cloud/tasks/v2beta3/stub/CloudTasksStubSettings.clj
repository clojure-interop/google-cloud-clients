(ns com.google.cloud.tasks.v2beta3.stub.CloudTasksStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.tasks.v2beta3.stub.CloudTasksStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (CloudTasksStubSettings/newBuilder client-context))
  (^com.google.cloud.tasks.v2beta3.stub.CloudTasksStubSettings$Builder []
    (CloudTasksStubSettings/newBuilder )))
...
(defn to-builder
  ...
  returns: `com.google.cloud.tasks.v2beta3.stub.CloudTasksStubSettings$Builder`"
  (^com.google.cloud.tasks.v2beta3.stub.CloudTasksStubSettings$Builder [^CloudTasksStubSettings this]
    (-> this (.toBuilder))))
