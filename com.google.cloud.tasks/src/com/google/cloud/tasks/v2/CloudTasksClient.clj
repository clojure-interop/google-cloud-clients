(ns com.google.cloud.tasks.v2.CloudTasksClient
...
(defn *create
  ...
  settings - `com.google.cloud.tasks.v2.CloudTasksSettings`

  returns: `com.google.cloud.tasks.v2.CloudTasksClient`

  throws: java.io.IOException"
  (^com.google.cloud.tasks.v2.CloudTasksClient [^com.google.cloud.tasks.v2.CloudTasksSettings settings]
...
(defn list-tasks-paged-callable
  "Lists the tasks in a queue.
   ...
   By default, only the [BASIC][google.cloud.tasks.v2.Task.View.BASIC] view is retrieved due to
...
(defn set-iam-policy
  ...
  resource - REQUIRED: The resource for which the policy is being specified. See the operation documentation for the appropriate value for this field. - `com.google.cloud.tasks.v2.QueueName`
  ...
  (^com.google.iam.v1.Policy [^CloudTasksClient this ^com.google.cloud.tasks.v2.QueueName resource ^com.google.iam.v1.Policy policy]
...
(defn pause-queue
  ...
  name - Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2.QueueName`

  returns: `com.google.cloud.tasks.v2.Queue`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2.QueueName name]
...
(defn list-queues
  ...
  parent - Required. The location name. For example: `projects/PROJECT_ID/locations/LOCATION_ID` - `com.google.cloud.tasks.v2.LocationName`

  returns: `com.google.cloud.tasks.v2.CloudTasksClient$ListQueuesPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2.CloudTasksClient$ListQueuesPagedResponse [^CloudTasksClient this ^com.google.cloud.tasks.v2.LocationName parent]
    (-> this (.listQueues parent))))

(defn get-settings
  "returns: `com.google.cloud.tasks.v2.CloudTasksSettings`"
  (^com.google.cloud.tasks.v2.CloudTasksSettings [^CloudTasksClient this]
    (-> this (.getSettings))))
...
(defn update-queue
  ...
  queue - Required. The queue to create or update. The queue's [name][google.cloud.tasks.v2.Queue.name] must be specified. Output only fields cannot be modified using UpdateQueue. Any value specified for an output only field will be ignored. The queue's [name][google.cloud.tasks.v2.Queue.name] cannot be changed. - `com.google.cloud.tasks.v2.Queue`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2.Queue queue ^com.google.protobuf.FieldMask update-mask]
    (-> this (.updateQueue queue update-mask)))
  (^com.google.cloud.tasks.v2.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2.UpdateQueueRequest request]
...
(defn run-task
  ...
  name - Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID` - `com.google.cloud.tasks.v2.TaskName`

  returns: `com.google.cloud.tasks.v2.Task`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2.Task [^CloudTasksClient this ^com.google.cloud.tasks.v2.TaskName name]
    (-> this (.runTask name))))
...
(defn create-queue
  ...
  parent - Required. The location name in which the queue will be created. For example: `projects/PROJECT_ID/locations/LOCATION_ID` The list of allowed locations can be obtained by calling Cloud Tasks' implementation of [ListLocations][google.cloud.location.Locations.ListLocations]. - `com.google.cloud.tasks.v2.LocationName`
  queue - Required. The queue to create. [Queue's name][google.cloud.tasks.v2.Queue.name] cannot be the same as an existing queue. - `com.google.cloud.tasks.v2.Queue`

  returns: `com.google.cloud.tasks.v2.Queue`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2.LocationName parent ^com.google.cloud.tasks.v2.Queue queue]
    (-> this (.createQueue parent queue)))
  (^com.google.cloud.tasks.v2.Queue [^CloudTasksClient this ^com.google.cloud.tasks.v2.CreateQueueRequest request]
...
(defn delete-queue
  ...
  name - Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2.QueueName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^CloudTasksClient this ^com.google.cloud.tasks.v2.QueueName name]
...
(defn delete-task
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^CloudTasksClient this ^com.google.cloud.tasks.v2.TaskName name]
...
(defn get-iam-policy
  ...
  resource - REQUIRED: The resource for which the policy is being requested. See the operation documentation for the appropriate value for this field. - `com.google.cloud.tasks.v2.QueueName`

  returns: `com.google.iam.v1.Policy`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.iam.v1.Policy [^CloudTasksClient this ^com.google.cloud.tasks.v2.QueueName resource]
...
(defn get-queue
  ...
  name - Required. The resource name of the queue. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2.QueueName`
...
(defn list-tasks
  ...
  parent - Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` - `com.google.cloud.tasks.v2.QueueName`

  returns: `com.google.cloud.tasks.v2.CloudTasksClient$ListTasksPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.tasks.v2.CloudTasksClient$ListTasksPagedResponse [^CloudTasksClient this ^com.google.cloud.tasks.v2.QueueName parent]
...
(defn test-iam-permissions
  ...
  resource - REQUIRED: The resource for which the policy detail is being requested. See the operation documentation for the appropriate value for this field. - `com.google.cloud.tasks.v2.QueueName`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.iam.v1.TestIamPermissionsResponse [^CloudTasksClient this ^com.google.cloud.tasks.v2.QueueName resource ^java.util.List permissions]
