(ns com.google.cloud.tasks.v2.CloudTasksSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.tasks.v2.CloudTasksSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (CloudTasksSettings/newBuilder client-context))
  (^com.google.cloud.tasks.v2.CloudTasksSettings$Builder []
    (CloudTasksSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.tasks.v2.stub.CloudTasksStubSettings`

  returns: `com.google.cloud.tasks.v2.CloudTasksSettings`

  throws: java.io.IOException"
  (^com.google.cloud.tasks.v2.CloudTasksSettings [^com.google.cloud.tasks.v2.stub.CloudTasksStubSettings stub]
...
(defn to-builder
  ...
  returns: `com.google.cloud.tasks.v2.CloudTasksSettings$Builder`"
  (^com.google.cloud.tasks.v2.CloudTasksSettings$Builder [^CloudTasksSettings this]
    (-> this (.toBuilder))))
