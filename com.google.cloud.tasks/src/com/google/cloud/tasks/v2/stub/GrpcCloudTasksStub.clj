(ns com.google.cloud.tasks.v2.stub.GrpcCloudTasksStub
...
(defn *create
  ...
  returns: `com.google.cloud.tasks.v2.stub.GrpcCloudTasksStub`

  throws: java.io.IOException"
  (^com.google.cloud.tasks.v2.stub.GrpcCloudTasksStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcCloudTasksStub/create client-context callable-factory))
  (^com.google.cloud.tasks.v2.stub.GrpcCloudTasksStub [^com.google.cloud.tasks.v2.stub.CloudTasksStubSettings settings]
