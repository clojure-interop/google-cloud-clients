(ns com.google.cloud.tasks.v2.stub.CloudTasksStubSettings$Builder
  "Builder for CloudTasksStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.tasks.v2.stub CloudTasksStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.tasks.v2.stub.CloudTasksStubSettings$Builder [^CloudTasksStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  "returns: `com.google.cloud.tasks.v2.stub.CloudTasksStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.tasks.v2.stub.CloudTasksStubSettings [^CloudTasksStubSettings$Builder this]
    (-> this (.build))))
