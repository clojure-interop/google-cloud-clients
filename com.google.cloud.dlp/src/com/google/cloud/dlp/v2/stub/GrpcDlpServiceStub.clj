(ns com.google.cloud.dlp.v2.stub.GrpcDlpServiceStub
...
(defn *create
  ...
  returns: `com.google.cloud.dlp.v2.stub.GrpcDlpServiceStub`

  throws: java.io.IOException"
  (^com.google.cloud.dlp.v2.stub.GrpcDlpServiceStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcDlpServiceStub/create client-context callable-factory))
  (^com.google.cloud.dlp.v2.stub.GrpcDlpServiceStub [^com.google.cloud.dlp.v2.stub.DlpServiceStubSettings settings]
    (GrpcDlpServiceStub/create settings)))
...
(defn update-deidentify-template-callable
  ...
  (^com.google.api.gax.rpc.UnaryCallable [^GrpcDlpServiceStub this]
...
(defn shutdown?
  "returns: `boolean`"
  (^Boolean [^GrpcDlpServiceStub this]
    (-> this (.isShutdown))))
...
(defn await-termination
  ...
  (^Boolean [^GrpcDlpServiceStub this ^Long duration ^java.util.concurrent.TimeUnit unit]
