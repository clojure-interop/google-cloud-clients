(ns com.google.cloud.automl.v1beta1.stub.AutoMlStubSettings$Builder
  "Builder for AutoMlStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.automl.v1beta1.stub AutoMlStubSettings$Builder]))

(defn deploy-model-operation-settings
  "Returns the builder for the settings used for calls to deployModel.

  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.DeployModelRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn create-model-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^AutoMlStubSettings$Builder this]
...
(defn create-model-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.CreateModelRequest,com.google.cloud.automl.v1beta1.Model,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.automl.v1beta1.stub.AutoMlStubSettings$Builder [^AutoMlStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn delete-dataset-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.DeleteDatasetRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn export-evaluated-examples-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.ExportEvaluatedExamplesRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn export-data-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.ExportDataRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn delete-model-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.DeleteModelRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn list-table-specs-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^AutoMlStubSettings$Builder this]
...
(defn import-data-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.ImportDataRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
    (-> this (.importDataOperationSettings))))

(defn build
  "returns: `com.google.cloud.automl.v1beta1.stub.AutoMlStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.automl.v1beta1.stub.AutoMlStubSettings [^AutoMlStubSettings$Builder this]
    (-> this (.build))))

(defn undeploy-model-operation-settings
  "Returns the builder for the settings used for calls to undeployModel.

  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.UndeployModelRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
...
(defn unary-method-settings-builders
  ...
  (^com.google.common.collect.ImmutableList [^AutoMlStubSettings$Builder this]
    (-> this (.unaryMethodSettingsBuilders))))

(defn export-model-operation-settings
  "Returns the builder for the settings used for calls to exportModel.

  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.automl.v1beta1.ExportModelRequest,com.google.protobuf.Empty,com.google.cloud.automl.v1beta1.OperationMetadata>`"
  ([^AutoMlStubSettings$Builder this]
