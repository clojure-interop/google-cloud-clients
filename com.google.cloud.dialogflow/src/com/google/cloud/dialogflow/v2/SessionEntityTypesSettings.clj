(ns com.google.cloud.dialogflow.v2.SessionEntityTypesSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dialogflow.v2.SessionEntityTypesSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (SessionEntityTypesSettings/newBuilder client-context))
  (^com.google.cloud.dialogflow.v2.SessionEntityTypesSettings$Builder []
    (SessionEntityTypesSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings`

  returns: `com.google.cloud.dialogflow.v2.SessionEntityTypesSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.SessionEntityTypesSettings [^com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings stub]
...
(defn to-builder
  ...
  returns: `com.google.cloud.dialogflow.v2.SessionEntityTypesSettings$Builder`"
  (^com.google.cloud.dialogflow.v2.SessionEntityTypesSettings$Builder [^SessionEntityTypesSettings this]
    (-> this (.toBuilder))))
