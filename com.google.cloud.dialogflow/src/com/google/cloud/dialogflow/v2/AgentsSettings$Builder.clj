(ns com.google.cloud.dialogflow.v2.AgentsSettings$Builder
  "Builder for AgentsSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dialogflow.v2 AgentsSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dialogflow.v2.AgentsSettings$Builder [^AgentsSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn export-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.ExportAgentRequest,com.google.cloud.dialogflow.v2.ExportAgentResponse,com.google.protobuf.Struct>`"
...
(defn train-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.TrainAgentRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^AgentsSettings$Builder this]
...
(defn restore-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.RestoreAgentRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^AgentsSettings$Builder this]
...
(defn import-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.ImportAgentRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^AgentsSettings$Builder this]
...
(defn build
  ...
  (^com.google.cloud.dialogflow.v2.AgentsSettings [^AgentsSettings$Builder this]
    (-> this (.build))))

(defn get-stub-settings-builder
  "returns: `com.google.cloud.dialogflow.v2.stub.AgentsStubSettings$Builder`"
  (^com.google.cloud.dialogflow.v2.stub.AgentsStubSettings$Builder [^AgentsSettings$Builder this]
