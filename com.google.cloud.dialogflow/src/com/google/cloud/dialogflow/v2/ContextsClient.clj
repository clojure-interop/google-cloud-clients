(ns com.google.cloud.dialogflow.v2.ContextsClient
...
(defn *create
  ...
  settings - `com.google.cloud.dialogflow.v2.ContextsSettings`

  returns: `com.google.cloud.dialogflow.v2.ContextsClient`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.ContextsClient [^com.google.cloud.dialogflow.v2.ContextsSettings settings]
    (ContextsClient/create settings))
  (^com.google.cloud.dialogflow.v2.ContextsClient []
...
(defn delete-context
  ...
  name - Required. The name of the context to delete. Format: `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context ID>`. - `com.google.cloud.dialogflow.v2.ContextName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ContextsClient this ^com.google.cloud.dialogflow.v2.ContextName name]
    (-> this (.deleteContext name))))

(defn get-settings
  "returns: `com.google.cloud.dialogflow.v2.ContextsSettings`"
  (^com.google.cloud.dialogflow.v2.ContextsSettings [^ContextsClient this]
    (-> this (.getSettings))))
...
(defn delete-all-contexts
  ...
  parent - Required. The name of the session to delete all contexts from. Format: `projects/<Project ID>/agent/sessions/<Session ID>`. - `com.google.cloud.dialogflow.v2.SessionName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^ContextsClient this ^com.google.cloud.dialogflow.v2.SessionName parent]
    (-> this (.deleteAllContexts parent))))

(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.dialogflow.v2.stub.ContextsStub`"
  ([^ContextsClient this]
    (-> this (.getStub))))
...
(defn create-context
  ...
  parent - Required. The session to create a context for. Format: `projects/<Project ID>/agent/sessions/<Session ID>`. - `com.google.cloud.dialogflow.v2.SessionName`
  context - Required. The context to create. - `com.google.cloud.dialogflow.v2.Context`

  returns: `com.google.cloud.dialogflow.v2.Context`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.Context [^ContextsClient this ^com.google.cloud.dialogflow.v2.SessionName parent ^com.google.cloud.dialogflow.v2.Context context]
    (-> this (.createContext parent context)))
  (^com.google.cloud.dialogflow.v2.Context [^ContextsClient this ^com.google.cloud.dialogflow.v2.CreateContextRequest request]
...
(defn get-context
  ...
  name - Required. The name of the context. Format: `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context ID>`. - `com.google.cloud.dialogflow.v2.ContextName`

  returns: `com.google.cloud.dialogflow.v2.Context`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.Context [^ContextsClient this ^com.google.cloud.dialogflow.v2.ContextName name]
...
(defn list-contexts
  ...
  parent - Required. The session to list all contexts from. Format: `projects/<Project ID>/agent/sessions/<Session ID>`. - `com.google.cloud.dialogflow.v2.SessionName`

  returns: `com.google.cloud.dialogflow.v2.ContextsClient$ListContextsPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.ContextsClient$ListContextsPagedResponse [^ContextsClient this ^com.google.cloud.dialogflow.v2.SessionName parent]
...
(defn update-context
  ...
  context - Required. The context to update. - `com.google.cloud.dialogflow.v2.Context`

  returns: `com.google.cloud.dialogflow.v2.Context`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.Context [^ContextsClient this ^com.google.cloud.dialogflow.v2.Context context]
