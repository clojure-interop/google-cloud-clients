(ns com.google.cloud.dialogflow.v2.IntentsClient
...
(defn *create
  ...
  settings - `com.google.cloud.dialogflow.v2.IntentsSettings`

  returns: `com.google.cloud.dialogflow.v2.IntentsClient`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.IntentsClient [^com.google.cloud.dialogflow.v2.IntentsSettings settings]
...
(defn update-intent
  ...
  intent - Required. The intent to update. - `com.google.cloud.dialogflow.v2.Intent`
  ...
  returns: `com.google.cloud.dialogflow.v2.Intent`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.Intent intent ^java.lang.String language-code ^com.google.protobuf.FieldMask update-mask]
    (-> this (.updateIntent intent language-code update-mask)))
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.Intent intent ^java.lang.String language-code]
    (-> this (.updateIntent intent language-code)))
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.UpdateIntentRequest request]
...
(defn list-intents
  ...
  parent - Required. The agent to list all intents from. Format: `projects/<Project ID>/agent`. - `com.google.cloud.dialogflow.v2.ProjectAgentName`
  ...
  returns: `com.google.cloud.dialogflow.v2.IntentsClient$ListIntentsPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.IntentsClient$ListIntentsPagedResponse [^IntentsClient this ^com.google.cloud.dialogflow.v2.ProjectAgentName parent ^java.lang.String language-code]
    (-> this (.listIntents parent language-code)))
  (^com.google.cloud.dialogflow.v2.IntentsClient$ListIntentsPagedResponse [^IntentsClient this ^com.google.cloud.dialogflow.v2.ProjectAgentName parent]
...
(defn get-settings
  "returns: `com.google.cloud.dialogflow.v2.IntentsSettings`"
  (^com.google.cloud.dialogflow.v2.IntentsSettings [^IntentsClient this]
    (-> this (.getSettings))))
...
(defn batch-update-intents-async
  ...
  request - The request object containing all of the parameters for the API call. - `com.google.cloud.dialogflow.v2.BatchUpdateIntentsRequest`

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.dialogflow.v2.BatchUpdateIntentsResponse,com.google.protobuf.Struct>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^IntentsClient this ^com.google.cloud.dialogflow.v2.BatchUpdateIntentsRequest request]
    (-> this (.batchUpdateIntentsAsync request))))

(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.dialogflow.v2.stub.IntentsStub`"
  ([^IntentsClient this]
    (-> this (.getStub))))
...
(defn batch-delete-intents-async
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^IntentsClient this ^com.google.cloud.dialogflow.v2.ProjectAgentName parent ^java.util.List intents]
    (-> this (.batchDeleteIntentsAsync parent intents)))
  ([^IntentsClient this ^com.google.cloud.dialogflow.v2.BatchDeleteIntentsRequest request]
...
(defn get-intent
  ...
  name - Required. The name of the intent. Format: `projects/<Project ID>/agent/intents/<Intent ID>`. - `com.google.cloud.dialogflow.v2.IntentName`
  language-code - Optional. The language to retrieve training phrases, parameters and rich messages for. If not specified, the agent's default language is used. [Many languages](https://cloud.google.com/dialogflow/docs/reference/language) are supported. Note: languages must be enabled in the agent before they can be used. - `java.lang.String`

  returns: `com.google.cloud.dialogflow.v2.Intent`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.IntentName name ^java.lang.String language-code]
    (-> this (.getIntent name language-code)))
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.IntentName name]
    (-> this (.getIntent name))))
...
(defn create-intent
  ...
  parent - Required. The agent to create a intent for. Format: `projects/<Project ID>/agent`. - `com.google.cloud.dialogflow.v2.ProjectAgentName`
  intent - Required. The intent to create. - `com.google.cloud.dialogflow.v2.Intent`
  language-code - Optional. The language of training phrases, parameters and rich messages defined in `intent`. If not specified, the agent's default language is used. [Many languages](https://cloud.google.com/dialogflow/docs/reference/language) are supported. Note: languages must be enabled in the agent before they can be used. - `java.lang.String`

  returns: `com.google.cloud.dialogflow.v2.Intent`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.ProjectAgentName parent ^com.google.cloud.dialogflow.v2.Intent intent ^java.lang.String language-code]
    (-> this (.createIntent parent intent language-code)))
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.ProjectAgentName parent ^com.google.cloud.dialogflow.v2.Intent intent]
    (-> this (.createIntent parent intent)))
  (^com.google.cloud.dialogflow.v2.Intent [^IntentsClient this ^com.google.cloud.dialogflow.v2.CreateIntentRequest request]
...
(defn delete-intent
  ...
  name - Required. The name of the intent to delete. If this intent has direct or indirect followup intents, we also delete them. Format: `projects/<Project ID>/agent/intents/<Intent ID>`. - `com.google.cloud.dialogflow.v2.IntentName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^IntentsClient this ^com.google.cloud.dialogflow.v2.IntentName name]
