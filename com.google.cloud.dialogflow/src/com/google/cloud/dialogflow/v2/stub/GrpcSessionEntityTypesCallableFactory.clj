(ns com.google.cloud.dialogflow.v2.stub.GrpcSessionEntityTypesCallableFactory
  "gRPC callable factory implementation for Dialogflow API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dialogflow.v2.stub GrpcSessionEntityTypesCallableFactory]))
