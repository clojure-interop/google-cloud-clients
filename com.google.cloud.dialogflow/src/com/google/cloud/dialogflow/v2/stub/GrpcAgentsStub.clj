(ns com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub
...
(defn *create
  ...
  returns: `com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcAgentsStub/create client-context callable-factory))
  (^com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub [^com.google.cloud.dialogflow.v2.stub.AgentsStubSettings settings]
