(ns com.google.cloud.dialogflow.v2.stub.SessionsStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dialogflow.v2.stub.SessionsStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (SessionsStubSettings/newBuilder client-context))
  (^com.google.cloud.dialogflow.v2.stub.SessionsStubSettings$Builder []
    (SessionsStubSettings/newBuilder )))

(defn detect-intent-settings
  "Returns the object with the settings used for calls to detectIntent.

  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dialogflow.v2.DetectIntentRequest,com.google.cloud.dialogflow.v2.DetectIntentResponse>`"
...
(defn streaming-detect-intent-settings
  ...
  returns: `com.google.api.gax.rpc.StreamingCallSettings<com.google.cloud.dialogflow.v2.StreamingDetectIntentRequest,com.google.cloud.dialogflow.v2.StreamingDetectIntentResponse>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.dialogflow.v2.stub.SessionsStubSettings$Builder`"
  (^com.google.cloud.dialogflow.v2.stub.SessionsStubSettings$Builder [^SessionsStubSettings this]
    (-> this (.toBuilder))))
