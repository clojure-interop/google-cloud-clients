(ns com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings$Builder
  "Builder for SessionEntityTypesStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dialogflow.v2.stub SessionEntityTypesStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings$Builder [^SessionEntityTypesStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  "returns: `com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings [^SessionEntityTypesStubSettings$Builder this]
    (-> this (.build))))
