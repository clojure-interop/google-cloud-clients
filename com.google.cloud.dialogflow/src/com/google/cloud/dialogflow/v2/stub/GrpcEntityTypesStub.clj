(ns com.google.cloud.dialogflow.v2.stub.GrpcEntityTypesStub
...
(defn *create
  ...
  returns: `com.google.cloud.dialogflow.v2.stub.GrpcEntityTypesStub`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.stub.GrpcEntityTypesStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcEntityTypesStub/create client-context callable-factory))
  (^com.google.cloud.dialogflow.v2.stub.GrpcEntityTypesStub [^com.google.cloud.dialogflow.v2.stub.EntityTypesStubSettings settings]
