(ns com.google.cloud.dialogflow.v2.stub.EntityTypesStubSettings$Builder
  "Builder for EntityTypesStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dialogflow.v2.stub EntityTypesStubSettings$Builder]))
...
(defn batch-delete-entity-types-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.BatchDeleteEntityTypesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dialogflow.v2.stub.EntityTypesStubSettings$Builder [^EntityTypesStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
    (-> this (.applyToAllUnaryMethods settings-updater))))

(defn batch-delete-entities-operation-settings
  "Returns the builder for the settings used for calls to batchDeleteEntities.

  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.BatchDeleteEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings$Builder this]
...
(defn batch-update-entity-types-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.BatchUpdateEntityTypesRequest,com.google.cloud.dialogflow.v2.BatchUpdateEntityTypesResponse,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings$Builder this]
...
(defn batch-update-entities-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.BatchUpdateEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings$Builder this]
    (-> this (.batchUpdateEntitiesOperationSettings))))

(defn build
  "returns: `com.google.cloud.dialogflow.v2.stub.EntityTypesStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2.stub.EntityTypesStubSettings [^EntityTypesStubSettings$Builder this]
    (-> this (.build))))
...
(defn batch-create-entities-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2.BatchCreateEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings$Builder this]
