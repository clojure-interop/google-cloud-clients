(ns com.google.cloud.dialogflow.v2beta1.AgentsSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dialogflow.v2beta1.AgentsSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (AgentsSettings/newBuilder client-context))
  (^com.google.cloud.dialogflow.v2beta1.AgentsSettings$Builder []
    (AgentsSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.dialogflow.v2beta1.stub.AgentsStubSettings`

  returns: `com.google.cloud.dialogflow.v2beta1.AgentsSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2beta1.AgentsSettings [^com.google.cloud.dialogflow.v2beta1.stub.AgentsStubSettings stub]
...
(defn export-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.ExportAgentRequest,com.google.cloud.dialogflow.v2beta1.ExportAgentResponse,com.google.protobuf.Struct>`"
  ([^AgentsSettings this]
...
(defn train-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.TrainAgentRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^AgentsSettings this]
...
(defn restore-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.RestoreAgentRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^AgentsSettings this]
...
(defn import-agent-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.ImportAgentRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^AgentsSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.dialogflow.v2beta1.AgentsSettings$Builder`"
  (^com.google.cloud.dialogflow.v2beta1.AgentsSettings$Builder [^AgentsSettings this]
    (-> this (.toBuilder))))
