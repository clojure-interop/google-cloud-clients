(ns com.google.cloud.dialogflow.v2beta1.EntityTypesClient
...
(defn *create
  ...
  settings - `com.google.cloud.dialogflow.v2beta1.EntityTypesSettings`

  returns: `com.google.cloud.dialogflow.v2beta1.EntityTypesClient`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesClient [^com.google.cloud.dialogflow.v2beta1.EntityTypesSettings settings]
    (EntityTypesClient/create settings))
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesClient []
...
(defn update-entity-type
  ...
  entity-type - Required. The entity type to update. - `com.google.cloud.dialogflow.v2beta1.EntityType`
  ...
  returns: `com.google.cloud.dialogflow.v2beta1.EntityType`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityType entity-type ^java.lang.String language-code]
    (-> this (.updateEntityType entity-type language-code)))
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityType entity-type]
...
(defn batch-update-entity-types-async
  ...
  request - The request object containing all of the parameters for the API call. - `com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesRequest`

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesResponse,com.google.protobuf.Struct>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesRequest request]
...
(defn get-settings
  ...
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesSettings [^EntityTypesClient this]
    (-> this (.getSettings))))
...
(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStub`"
  ([^EntityTypesClient this]
    (-> this (.getStub))))
...
(defn batch-update-entities-async
  ...
  parent - Required. The name of the entity type to update or create entities in. Format: `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`. - `com.google.cloud.dialogflow.v2beta1.EntityTypeName`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName parent ^java.util.List entities ^java.lang.String language-code]
    (-> this (.batchUpdateEntitiesAsync parent entities language-code)))
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName parent ^java.util.List entities]
    (-> this (.batchUpdateEntitiesAsync parent entities)))
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.BatchUpdateEntitiesRequest request]
...
(defn get-entity-type
  ...
  name - Required. The name of the entity type. Format: `projects/<Project ID>/agent/entityTypes/<EntityType ID>`. - `com.google.cloud.dialogflow.v2beta1.EntityTypeName`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName name ^java.lang.String language-code]
    (-> this (.getEntityType name language-code)))
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName name]
...
(defn batch-create-entities-async
  ...
  parent - Required. The name of the entity type to create entities in. Format: `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`. - `com.google.cloud.dialogflow.v2beta1.EntityTypeName`
  ...
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.BatchCreateEntitiesRequest request]
...
(defn batch-delete-entity-types-async
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.ProjectAgentName parent ^java.util.List entity-type-names]
    (-> this (.batchDeleteEntityTypesAsync parent entity-type-names)))
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest request]
...
(defn batch-delete-entities-async
  ...
  parent - Required. The name of the entity type to delete entries for. Format: `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`. - `com.google.cloud.dialogflow.v2beta1.EntityTypeName`
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName parent ^java.util.List entity-values ^java.lang.String language-code]
    (-> this (.batchDeleteEntitiesAsync parent entity-values language-code)))
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName parent ^java.util.List entity-values]
    (-> this (.batchDeleteEntitiesAsync parent entity-values)))
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.BatchDeleteEntitiesRequest request]
...
(defn create-entity-type
  ...
  parent - Required. The agent to create a entity type for. Format: `projects/<Project ID>/agent`. - `com.google.cloud.dialogflow.v2beta1.ProjectAgentName`
  entity-type - Required. The entity type to create. - `com.google.cloud.dialogflow.v2beta1.EntityType`
  language-code - Optional. The language of entity synonyms defined in `entity_type`. If not specified, the agent's default language is used. [Many languages](https://cloud.google.com/dialogflow/docs/reference/language) are supported. Note: languages must be enabled in the agent before they can be used. - `java.lang.String`

  returns: `com.google.cloud.dialogflow.v2beta1.EntityType`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.ProjectAgentName parent ^com.google.cloud.dialogflow.v2beta1.EntityType entity-type ^java.lang.String language-code]
    (-> this (.createEntityType parent entity-type language-code)))
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.ProjectAgentName parent ^com.google.cloud.dialogflow.v2beta1.EntityType entity-type]
    (-> this (.createEntityType parent entity-type)))
  (^com.google.cloud.dialogflow.v2beta1.EntityType [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.CreateEntityTypeRequest request]
...
(defn list-entity-types
  ...
  parent - Required. The agent to list all entity types from. Format: `projects/<Project ID>/agent`. - `com.google.cloud.dialogflow.v2beta1.ProjectAgentName`
  ...
  returns: `com.google.cloud.dialogflow.v2beta1.EntityTypesClient$ListEntityTypesPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesClient$ListEntityTypesPagedResponse [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.ProjectAgentName parent ^java.lang.String language-code]
    (-> this (.listEntityTypes parent language-code)))
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesClient$ListEntityTypesPagedResponse [^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.ProjectAgentName parent]
...
(defn delete-entity-type
  ...
  name - Required. The name of the entity type to delete. Format: `projects/<Project ID>/agent/entityTypes/<EntityType ID>`. - `com.google.cloud.dialogflow.v2beta1.EntityTypeName`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^EntityTypesClient this ^com.google.cloud.dialogflow.v2beta1.EntityTypeName name]
