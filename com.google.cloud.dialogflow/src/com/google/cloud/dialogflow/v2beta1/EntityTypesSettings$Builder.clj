(ns com.google.cloud.dialogflow.v2beta1.EntityTypesSettings$Builder
  "Builder for EntityTypesSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dialogflow.v2beta1 EntityTypesSettings$Builder]))
...
(defn batch-delete-entity-types-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesSettings$Builder [^EntityTypesSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
    (-> this (.applyToAllUnaryMethods settings-updater))))

(defn batch-delete-entities-operation-settings
  "Returns the builder for the settings used for calls to batchDeleteEntities.

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2beta1.BatchDeleteEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesSettings$Builder this]
...
(defn batch-update-entity-types-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesRequest,com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesResponse,com.google.protobuf.Struct>`"
  ([^EntityTypesSettings$Builder this]
...
(defn batch-update-entities-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2beta1.BatchUpdateEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesSettings$Builder this]
...
(defn build
  ...
  (^com.google.cloud.dialogflow.v2beta1.EntityTypesSettings [^EntityTypesSettings$Builder this]
    (-> this (.build))))
...
(defn get-stub-settings-builder
  ...
  (^com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStubSettings$Builder [^EntityTypesSettings$Builder this]
...
(defn batch-create-entities-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dialogflow.v2beta1.BatchCreateEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesSettings$Builder this]
