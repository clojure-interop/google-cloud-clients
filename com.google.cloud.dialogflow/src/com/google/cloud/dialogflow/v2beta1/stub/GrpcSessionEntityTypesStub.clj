(ns com.google.cloud.dialogflow.v2beta1.stub.GrpcSessionEntityTypesStub
...
(defn *create
  ...
  returns: `com.google.cloud.dialogflow.v2beta1.stub.GrpcSessionEntityTypesStub`

  throws: java.io.IOException"
  (^com.google.cloud.dialogflow.v2beta1.stub.GrpcSessionEntityTypesStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcSessionEntityTypesStub/create client-context callable-factory))
  (^com.google.cloud.dialogflow.v2beta1.stub.GrpcSessionEntityTypesStub [^com.google.cloud.dialogflow.v2beta1.stub.SessionEntityTypesStubSettings settings]
