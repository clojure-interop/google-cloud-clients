(ns com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (EntityTypesStubSettings/newBuilder client-context))
  (^com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStubSettings$Builder []
    (EntityTypesStubSettings/newBuilder )))
...
(defn batch-delete-entity-types-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
...
(defn batch-delete-entities-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.BatchDeleteEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings this]
...
(defn batch-update-entity-types-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesRequest,com.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesResponse,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings this]
...
(defn batch-update-entities-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.BatchUpdateEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings this]
...
(defn batch-create-entities-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dialogflow.v2beta1.BatchCreateEntitiesRequest,com.google.protobuf.Empty,com.google.protobuf.Struct>`"
  ([^EntityTypesStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStubSettings$Builder`"
  (^com.google.cloud.dialogflow.v2beta1.stub.EntityTypesStubSettings$Builder [^EntityTypesStubSettings this]
    (-> this (.toBuilder))))
