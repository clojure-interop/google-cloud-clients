(ns com.google.cloud.dialogflow.v2beta1.SessionEntityTypesSettings$Builder
  "Builder for SessionEntityTypesSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dialogflow.v2beta1 SessionEntityTypesSettings$Builder]))

(defn get-stub-settings-builder
  "returns: `com.google.cloud.dialogflow.v2beta1.stub.SessionEntityTypesStubSettings$Builder`"
  (^com.google.cloud.dialogflow.v2beta1.stub.SessionEntityTypesStubSettings$Builder [^SessionEntityTypesSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dialogflow.v2beta1.SessionEntityTypesSettings$Builder [^SessionEntityTypesSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  ...
  (^com.google.cloud.dialogflow.v2beta1.SessionEntityTypesSettings [^SessionEntityTypesSettings$Builder this]
    (-> this (.build))))
