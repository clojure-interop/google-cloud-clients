(ns com.google.cloud.language.v1.LanguageServiceSettings
...
(defn *new-builder
  ...
  returns: `com.google.cloud.language.v1.LanguageServiceSettings$Builder`"
  (^com.google.cloud.language.v1.LanguageServiceSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (LanguageServiceSettings/newBuilder client-context))
  (^com.google.cloud.language.v1.LanguageServiceSettings$Builder []
    (LanguageServiceSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.language.v1.stub.LanguageServiceStubSettings`

  returns: `com.google.cloud.language.v1.LanguageServiceSettings`

  throws: java.io.IOException"
  (^com.google.cloud.language.v1.LanguageServiceSettings [^com.google.cloud.language.v1.stub.LanguageServiceStubSettings stub]
...
(defn to-builder
  ...
  returns: `com.google.cloud.language.v1.LanguageServiceSettings$Builder`"
  (^com.google.cloud.language.v1.LanguageServiceSettings$Builder [^LanguageServiceSettings this]
    (-> this (.toBuilder))))
