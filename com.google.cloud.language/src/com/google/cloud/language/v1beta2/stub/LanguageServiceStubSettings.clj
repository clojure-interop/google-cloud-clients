(ns com.google.cloud.language.v1beta2.stub.LanguageServiceStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.language.v1beta2.stub.LanguageServiceStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (LanguageServiceStubSettings/newBuilder client-context))
  (^com.google.cloud.language.v1beta2.stub.LanguageServiceStubSettings$Builder []
    (LanguageServiceStubSettings/newBuilder )))
...
(defn to-builder
  ...
  returns: `com.google.cloud.language.v1beta2.stub.LanguageServiceStubSettings$Builder`"
  (^com.google.cloud.language.v1beta2.stub.LanguageServiceStubSettings$Builder [^LanguageServiceStubSettings this]
    (-> this (.toBuilder))))
