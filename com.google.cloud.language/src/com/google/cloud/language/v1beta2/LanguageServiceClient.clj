(ns com.google.cloud.language.v1beta2.LanguageServiceClient
...
(defn *create
  ...
  settings - `com.google.cloud.language.v1beta2.LanguageServiceSettings`

  returns: `com.google.cloud.language.v1beta2.LanguageServiceClient`

  throws: java.io.IOException"
  (^com.google.cloud.language.v1beta2.LanguageServiceClient [^com.google.cloud.language.v1beta2.LanguageServiceSettings settings]
...
(defn analyze-sentiment
  ...
  document - Input document. - `com.google.cloud.language.v1beta2.Document`

  returns: `com.google.cloud.language.v1beta2.AnalyzeSentimentResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.language.v1beta2.AnalyzeSentimentResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.Document document]
    (-> this (.analyzeSentiment document))))

(defn get-settings
  "returns: `com.google.cloud.language.v1beta2.LanguageServiceSettings`"
  (^com.google.cloud.language.v1beta2.LanguageServiceSettings [^LanguageServiceClient this]
    (-> this (.getSettings))))
...
(defn analyze-syntax
  ...
  document - Input document. - `com.google.cloud.language.v1beta2.Document`
  encoding-type - The encoding type used by the API to calculate offsets. - `com.google.cloud.language.v1beta2.EncodingType`

  returns: `com.google.cloud.language.v1beta2.AnalyzeSyntaxResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.language.v1beta2.AnalyzeSyntaxResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.Document document ^com.google.cloud.language.v1beta2.EncodingType encoding-type]
    (-> this (.analyzeSyntax document encoding-type)))
  (^com.google.cloud.language.v1beta2.AnalyzeSyntaxResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.AnalyzeSyntaxRequest request]
    (-> this (.analyzeSyntax request))))

(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.language.v1beta2.stub.LanguageServiceStub`"
...
(defn classify-text
  ...
  returns: `com.google.cloud.language.v1beta2.ClassifyTextResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.language.v1beta2.ClassifyTextResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.Document document]
...
(defn analyze-entities
  ...
  returns: `com.google.cloud.language.v1beta2.AnalyzeEntitiesResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.language.v1beta2.AnalyzeEntitiesResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.Document document ^com.google.cloud.language.v1beta2.EncodingType encoding-type]
    (-> this (.analyzeEntities document encoding-type)))
  (^com.google.cloud.language.v1beta2.AnalyzeEntitiesResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.AnalyzeEntitiesRequest request]
    (-> this (.analyzeEntities request))))
...
(defn annotate-text
  ...
  document - Input document. - `com.google.cloud.language.v1beta2.Document`
  features - The enabled features. - `com.google.cloud.language.v1beta2.AnnotateTextRequest$Features`
  encoding-type - The encoding type used by the API to calculate offsets. - `com.google.cloud.language.v1beta2.EncodingType`

  returns: `com.google.cloud.language.v1beta2.AnnotateTextResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.language.v1beta2.AnnotateTextResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.Document document ^com.google.cloud.language.v1beta2.AnnotateTextRequest$Features features ^com.google.cloud.language.v1beta2.EncodingType encoding-type]
    (-> this (.annotateText document features encoding-type)))
  (^com.google.cloud.language.v1beta2.AnnotateTextResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.AnnotateTextRequest request]
...
(defn analyze-entity-sentiment
  ...
  returns: `com.google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.Document document ^com.google.cloud.language.v1beta2.EncodingType encoding-type]
    (-> this (.analyzeEntitySentiment document encoding-type)))
  (^com.google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse [^LanguageServiceClient this ^com.google.cloud.language.v1beta2.AnalyzeEntitySentimentRequest request]
    (-> this (.analyzeEntitySentiment request))))
