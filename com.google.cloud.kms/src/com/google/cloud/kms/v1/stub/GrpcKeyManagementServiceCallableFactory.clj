(ns com.google.cloud.kms.v1.stub.GrpcKeyManagementServiceCallableFactory
  "gRPC callable factory implementation for Cloud Key Management Service (KMS) API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.kms.v1.stub GrpcKeyManagementServiceCallableFactory]))

(defn ->grpc-key-management-service-callable-factory
  "Constructor."
  (^GrpcKeyManagementServiceCallableFactory []
    (new GrpcKeyManagementServiceCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^GrpcKeyManagementServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-paged-callable
  ...
  ([^GrpcKeyManagementServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^GrpcKeyManagementServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^GrpcKeyManagementServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.longrunning.stub.OperationsStub operations-stub]
...
(defn create-bidi-streaming-callable
  ...
  ([^GrpcKeyManagementServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.StreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-server-streaming-callable
  ...
  ([^GrpcKeyManagementServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.ServerStreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
