(ns com.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceServiceSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceServiceSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
...
(defn *create
  "stub - `com.google.cloud.videointelligence.v1p2beta1.stub.VideoIntelligenceServiceStubSettings`

  returns: `com.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceServiceSettings`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceServiceSettings [^com.google.cloud.videointelligence.v1p2beta1.stub.VideoIntelligenceServiceStubSettings stub]
...
(defn annotate-video-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.videointelligence.v1p2beta1.AnnotateVideoRequest,com.google.longrunning.Operation>`"
...
(defn annotate-video-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.videointelligence.v1p2beta1.AnnotateVideoRequest,com.google.cloud.videointelligence.v1p2beta1.AnnotateVideoResponse,com.google.cloud.videointelligence.v1p2beta1.AnnotateVideoProgress>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceServiceSettings$Builder`"
  (^com.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceServiceSettings$Builder [^VideoIntelligenceServiceSettings this]
    (-> this (.toBuilder))))
