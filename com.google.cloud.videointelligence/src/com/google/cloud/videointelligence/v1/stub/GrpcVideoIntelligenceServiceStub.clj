(ns com.google.cloud.videointelligence.v1.stub.GrpcVideoIntelligenceServiceStub
  "gRPC stub implementation for Cloud Video Intelligence API.

  This class is for advanced usage and reflects the underlying API directly."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.videointelligence.v1.stub GrpcVideoIntelligenceServiceStub]))

(defn *create
  "client-context - `com.google.api.gax.rpc.ClientContext`
  callable-factory - `com.google.api.gax.grpc.GrpcStubCallableFactory`

  returns: `com.google.cloud.videointelligence.v1.stub.GrpcVideoIntelligenceServiceStub`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1.stub.GrpcVideoIntelligenceServiceStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcVideoIntelligenceServiceStub/create client-context callable-factory))
  (^com.google.cloud.videointelligence.v1.stub.GrpcVideoIntelligenceServiceStub [^com.google.cloud.videointelligence.v1.stub.VideoIntelligenceServiceStubSettings settings]
