(ns com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings
...
(defn *new-builder
  ...
  returns: `com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings$Builder`"
  (^com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (VideoIntelligenceServiceSettings/newBuilder client-context))
  (^com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings$Builder []
    (VideoIntelligenceServiceSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.videointelligence.v1.stub.VideoIntelligenceServiceStubSettings`

  returns: `com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings [^com.google.cloud.videointelligence.v1.stub.VideoIntelligenceServiceStubSettings stub]
...
(defn annotate-video-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.videointelligence.v1.AnnotateVideoRequest,com.google.cloud.videointelligence.v1.AnnotateVideoResponse,com.google.cloud.videointelligence.v1.AnnotateVideoProgress>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings$Builder`"
  (^com.google.cloud.videointelligence.v1.VideoIntelligenceServiceSettings$Builder [^VideoIntelligenceServiceSettings this]
    (-> this (.toBuilder))))
