(ns com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceClient
...
(defn *create
  ...
  settings - `com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings`

  returns: `com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceClient`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceClient [^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings settings]
    (VideoIntelligenceServiceClient/create settings))
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceClient []
...
(defn annotate-video-async
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.videointelligence.v1beta2.AnnotateVideoResponse,com.google.cloud.videointelligence.v1beta2.AnnotateVideoProgress>`
  ...
  ([^VideoIntelligenceServiceClient this ^com.google.cloud.videointelligence.v1beta2.AnnotateVideoRequest request]
    (-> this (.annotateVideoAsync request))))

(defn get-settings
  "returns: `com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings`"
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings [^VideoIntelligenceServiceClient this]
    (-> this (.getSettings))))

(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.videointelligence.v1beta2.stub.VideoIntelligenceServiceStub`"
