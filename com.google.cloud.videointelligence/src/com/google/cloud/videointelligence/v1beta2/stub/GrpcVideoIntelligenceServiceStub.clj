(ns com.google.cloud.videointelligence.v1beta2.stub.GrpcVideoIntelligenceServiceStub
...
(defn *create
  ...
  returns: `com.google.cloud.videointelligence.v1beta2.stub.GrpcVideoIntelligenceServiceStub`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1beta2.stub.GrpcVideoIntelligenceServiceStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcVideoIntelligenceServiceStub/create client-context callable-factory))
  (^com.google.cloud.videointelligence.v1beta2.stub.GrpcVideoIntelligenceServiceStub [^com.google.cloud.videointelligence.v1beta2.stub.VideoIntelligenceServiceStubSettings settings]
