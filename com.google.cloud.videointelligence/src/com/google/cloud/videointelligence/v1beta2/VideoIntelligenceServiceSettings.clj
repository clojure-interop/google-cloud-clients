(ns com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings
...
(defn *new-builder
  ...
  returns: `com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings$Builder`"
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (VideoIntelligenceServiceSettings/newBuilder client-context))
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings$Builder []
    (VideoIntelligenceServiceSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.videointelligence.v1beta2.stub.VideoIntelligenceServiceStubSettings`

  returns: `com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings [^com.google.cloud.videointelligence.v1beta2.stub.VideoIntelligenceServiceStubSettings stub]
...
(defn annotate-video-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.videointelligence.v1beta2.AnnotateVideoRequest,com.google.longrunning.Operation>`"
...
(defn annotate-video-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.videointelligence.v1beta2.AnnotateVideoRequest,com.google.cloud.videointelligence.v1beta2.AnnotateVideoResponse,com.google.cloud.videointelligence.v1beta2.AnnotateVideoProgress>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings$Builder`"
  (^com.google.cloud.videointelligence.v1beta2.VideoIntelligenceServiceSettings$Builder [^VideoIntelligenceServiceSettings this]
    (-> this (.toBuilder))))
