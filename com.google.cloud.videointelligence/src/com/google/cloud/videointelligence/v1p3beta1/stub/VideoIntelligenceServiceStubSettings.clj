(ns com.google.cloud.videointelligence.v1p3beta1.stub.VideoIntelligenceServiceStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.videointelligence.v1p3beta1.stub.VideoIntelligenceServiceStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (VideoIntelligenceServiceStubSettings/newBuilder client-context))
  (^com.google.cloud.videointelligence.v1p3beta1.stub.VideoIntelligenceServiceStubSettings$Builder []
    (VideoIntelligenceServiceStubSettings/newBuilder )))
...
(defn annotate-video-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest,com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoResponse,com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoProgress>`"
...
(defn to-builder
  ...
  returns: `com.google.cloud.videointelligence.v1p3beta1.stub.VideoIntelligenceServiceStubSettings$Builder`"
  (^com.google.cloud.videointelligence.v1p3beta1.stub.VideoIntelligenceServiceStubSettings$Builder [^VideoIntelligenceServiceStubSettings this]
    (-> this (.toBuilder))))
