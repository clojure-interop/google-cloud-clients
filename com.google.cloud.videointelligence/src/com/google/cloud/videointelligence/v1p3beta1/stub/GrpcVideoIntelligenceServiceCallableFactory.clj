(ns com.google.cloud.videointelligence.v1p3beta1.stub.GrpcVideoIntelligenceServiceCallableFactory
  "gRPC callable factory implementation for Cloud Video Intelligence API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.videointelligence.v1p3beta1.stub GrpcVideoIntelligenceServiceCallableFactory]))
