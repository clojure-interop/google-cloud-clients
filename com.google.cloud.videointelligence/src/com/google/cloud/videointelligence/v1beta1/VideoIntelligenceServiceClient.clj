(ns com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceClient
...
(defn *create
  ...
  settings - `com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceSettings`

  returns: `com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceClient`

  throws: java.io.IOException"
  (^com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceClient [^com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceSettings settings]
    (VideoIntelligenceServiceClient/create settings))
  (^com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceClient []
...
(defn annotate-video-async
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.videointelligence.v1beta1.AnnotateVideoResponse,com.google.cloud.videointelligence.v1beta1.AnnotateVideoProgress>`
  ...
  ([^VideoIntelligenceServiceClient this ^com.google.cloud.videointelligence.v1beta1.AnnotateVideoRequest request]
    (-> this (.annotateVideoAsync request))))

(defn get-settings
  "returns: `com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceSettings`"
  (^com.google.cloud.videointelligence.v1beta1.VideoIntelligenceServiceSettings [^VideoIntelligenceServiceClient this]
    (-> this (.getSettings))))
...
(defn annotate-video-callable
  ...
  returns: `com.google.api.gax.rpc.UnaryCallable<com.google.cloud.videointelligence.v1beta1.AnnotateVideoRequest,com.google.longrunning.Operation>`"
...
(defn annotate-video-operation-callable
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")   com.google.api.gax.rpc.OperationCallable<com.google.cloud.videointelligence.v1beta1.AnnotateVideoRequest,com.google.cloud.videointelligence.v1beta1.AnnotateVideoResponse,com.google.cloud.videointelligence.v1beta1.AnnotateVideoProgress>`"
  ([^VideoIntelligenceServiceClient this]
