(ns com.google.cloud.datalabeling.v1beta1.stub.DataLabelingServiceStubSettings$Builder
  "Builder for DataLabelingServiceStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.datalabeling.v1beta1.stub DataLabelingServiceStubSettings$Builder]))
...
(defn get-annotation-spec-set-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^DataLabelingServiceStubSettings$Builder this]
...
(defn search-evaluations-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^DataLabelingServiceStubSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.datalabeling.v1beta1.stub.DataLabelingServiceStubSettings$Builder [^DataLabelingServiceStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn export-data-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.datalabeling.v1beta1.ExportDataRequest,com.google.cloud.datalabeling.v1beta1.ExportDataOperationResponse,com.google.cloud.datalabeling.v1beta1.ExportDataOperationMetadata>`"
  ([^DataLabelingServiceStubSettings$Builder this]
...
(defn build
  "returns: `com.google.cloud.datalabeling.v1beta1.stub.DataLabelingServiceStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.datalabeling.v1beta1.stub.DataLabelingServiceStubSettings [^DataLabelingServiceStubSettings$Builder this]
    (-> this (.build))))
...
(defn unary-method-settings-builders
  ...
  (^com.google.common.collect.ImmutableList [^DataLabelingServiceStubSettings$Builder this]
