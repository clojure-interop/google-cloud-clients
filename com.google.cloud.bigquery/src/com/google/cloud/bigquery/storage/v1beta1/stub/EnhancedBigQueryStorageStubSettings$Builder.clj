(ns com.google.cloud.bigquery.storage.v1beta1.stub.EnhancedBigQueryStorageStubSettings$Builder
  "Builder for EnhancedBigQueryStorageStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.bigquery.storage.v1beta1.stub EnhancedBigQueryStorageStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.bigquery.storage.v1beta1.stub.EnhancedBigQueryStorageStubSettings$Builder [^EnhancedBigQueryStorageStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
    (-> this (.applyToAllUnaryMethods settings-updater))))

(defn unary-method-settings-builders
  "returns: `com.google.common.collect.ImmutableList<com.google.api.gax.rpc.UnaryCallSettings.Builder<?,?>>`"
  (^com.google.common.collect.ImmutableList [^EnhancedBigQueryStorageStubSettings$Builder this]
...
(defn create-read-session-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^EnhancedBigQueryStorageStubSettings$Builder this]
...
(defn read-rows-settings
  ...
  (^com.google.api.gax.rpc.ServerStreamingCallSettings.Builder [^EnhancedBigQueryStorageStubSettings$Builder this]
...
(defn build
  "returns: `com.google.cloud.bigquery.storage.v1beta1.stub.EnhancedBigQueryStorageStubSettings`"
  (^com.google.cloud.bigquery.storage.v1beta1.stub.EnhancedBigQueryStorageStubSettings [^EnhancedBigQueryStorageStubSettings$Builder this]
    (-> this (.build))))
