(ns com.google.cloud.firestore.v1.stub.FirestoreStubSettings$Builder
  "Builder for FirestoreStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.firestore.v1.stub FirestoreStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.firestore.v1.stub.FirestoreStubSettings$Builder [^FirestoreStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  "returns: `com.google.cloud.firestore.v1.stub.FirestoreStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.firestore.v1.stub.FirestoreStubSettings [^FirestoreStubSettings$Builder this]
    (-> this (.build))))
