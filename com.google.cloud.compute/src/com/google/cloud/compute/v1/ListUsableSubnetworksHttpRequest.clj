(ns com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListUsableSubnetworksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest$Builder [^com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest prototype]
    (ListUsableSubnetworksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest$Builder []
    (ListUsableSubnetworksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest`"
  (^com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListUsableSubnetworksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListUsableSubnetworksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListUsableSubnetworksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListUsableSubnetworksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListUsableSubnetworksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListUsableSubnetworksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListUsableSubnetworksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListUsableSubnetworksHttpRequest$Builder [^ListUsableSubnetworksHttpRequest this]
    (-> this (.toBuilder))))
