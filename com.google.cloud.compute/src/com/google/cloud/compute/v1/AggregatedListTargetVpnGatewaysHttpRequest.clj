(ns com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListTargetVpnGatewaysHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest prototype]
    (AggregatedListTargetVpnGatewaysHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListTargetVpnGatewaysHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListTargetVpnGatewaysHttpRequest this]
    (-> this (.getUserIp))))

(defn get-project
  "Project ID for this request. It must have the format `{project}/aggregated/targetVpnGateways`.
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListTargetVpnGatewaysHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListTargetVpnGatewaysHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListTargetVpnGatewaysHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListTargetVpnGatewaysHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListTargetVpnGatewaysHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListTargetVpnGatewaysHttpRequest$Builder [^AggregatedListTargetVpnGatewaysHttpRequest this]
    (-> this (.toBuilder))))
