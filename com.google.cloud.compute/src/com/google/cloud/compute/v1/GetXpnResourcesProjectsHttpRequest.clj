(ns com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 GetXpnResourcesProjectsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest`

  returns: `com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest$Builder [^com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest prototype]
    (GetXpnResourcesProjectsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest$Builder []
    (GetXpnResourcesProjectsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest`"
  (^com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest []
    (GetXpnResourcesProjectsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^GetXpnResourcesProjectsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^GetXpnResourcesProjectsHttpRequest this]
    (-> this (.getUserIp))))

(defn get-project
  "Project ID for this request. It must have the format `{project}/getXpnResources`. \\`{project}\\`
...
(defn get-field-mask
  ...
  (^java.util.List [^GetXpnResourcesProjectsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^GetXpnResourcesProjectsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^GetXpnResourcesProjectsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^GetXpnResourcesProjectsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^GetXpnResourcesProjectsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.GetXpnResourcesProjectsHttpRequest$Builder [^GetXpnResourcesProjectsHttpRequest this]
    (-> this (.toBuilder))))
