(ns com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListManagedInstancesInstanceGroupManagersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest$Builder [^com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest prototype]
    (ListManagedInstancesInstanceGroupManagersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListManagedInstancesInstanceGroupManagersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListManagedInstancesInstanceGroupManagersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListManagedInstancesInstanceGroupManagersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListManagedInstancesInstanceGroupManagersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListManagedInstancesInstanceGroupManagersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListManagedInstancesInstanceGroupManagersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListManagedInstancesInstanceGroupManagersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListManagedInstancesInstanceGroupManagersHttpRequest$Builder [^ListManagedInstancesInstanceGroupManagersHttpRequest this]
    (-> this (.toBuilder))))
