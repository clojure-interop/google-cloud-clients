(ns com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInstanceTemplatesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest$Builder [^com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest prototype]
    (ListInstanceTemplatesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest$Builder []
    (ListInstanceTemplatesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest`"
  (^com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest []
    (ListInstanceTemplatesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInstanceTemplatesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInstanceTemplatesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInstanceTemplatesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInstanceTemplatesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInstanceTemplatesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInstanceTemplatesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInstanceTemplatesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstanceTemplatesHttpRequest$Builder [^ListInstanceTemplatesHttpRequest this]
    (-> this (.toBuilder))))
