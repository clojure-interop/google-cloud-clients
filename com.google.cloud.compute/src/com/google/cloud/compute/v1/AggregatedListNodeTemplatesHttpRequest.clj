(ns com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListNodeTemplatesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest prototype]
    (AggregatedListNodeTemplatesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest []
    (AggregatedListNodeTemplatesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListNodeTemplatesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListNodeTemplatesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListNodeTemplatesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListNodeTemplatesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListNodeTemplatesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListNodeTemplatesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListNodeTemplatesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListNodeTemplatesHttpRequest$Builder [^AggregatedListNodeTemplatesHttpRequest this]
    (-> this (.toBuilder))))
