(ns com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListSecurityPoliciesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest$Builder [^com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest prototype]
    (ListSecurityPoliciesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest$Builder []
    (ListSecurityPoliciesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest`"
  (^com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest []
    (ListSecurityPoliciesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListSecurityPoliciesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListSecurityPoliciesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListSecurityPoliciesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListSecurityPoliciesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListSecurityPoliciesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListSecurityPoliciesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListSecurityPoliciesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSecurityPoliciesHttpRequest$Builder [^ListSecurityPoliciesHttpRequest this]
    (-> this (.toBuilder))))
