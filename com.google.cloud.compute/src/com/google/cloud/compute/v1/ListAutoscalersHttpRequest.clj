(ns com.google.cloud.compute.v1.ListAutoscalersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListAutoscalersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListAutoscalersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListAutoscalersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAutoscalersHttpRequest$Builder [^com.google.cloud.compute.v1.ListAutoscalersHttpRequest prototype]
    (ListAutoscalersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListAutoscalersHttpRequest$Builder []
    (ListAutoscalersHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListAutoscalersHttpRequest`"
  (^com.google.cloud.compute.v1.ListAutoscalersHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListAutoscalersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListAutoscalersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListAutoscalersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListAutoscalersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListAutoscalersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListAutoscalersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListAutoscalersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListAutoscalersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAutoscalersHttpRequest$Builder [^ListAutoscalersHttpRequest this]
    (-> this (.toBuilder))))
