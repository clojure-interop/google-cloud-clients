(ns com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListXpnHostsProjectsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest$Builder [^com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest prototype]
    (ListXpnHostsProjectsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest$Builder []
    (ListXpnHostsProjectsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest`"
  (^com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest []
    (ListXpnHostsProjectsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListXpnHostsProjectsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListXpnHostsProjectsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListXpnHostsProjectsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListXpnHostsProjectsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.cloud.compute.v1.ProjectsListXpnHostsRequest [^ListXpnHostsProjectsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListXpnHostsProjectsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListXpnHostsProjectsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListXpnHostsProjectsHttpRequest$Builder [^ListXpnHostsProjectsHttpRequest this]
    (-> this (.toBuilder))))
