(ns com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionCommitmentsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest prototype]
    (ListRegionCommitmentsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest$Builder []
    (ListRegionCommitmentsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest`"
  (^com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest []
    (ListRegionCommitmentsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionCommitmentsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionCommitmentsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionCommitmentsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionCommitmentsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionCommitmentsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionCommitmentsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionCommitmentsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionCommitmentsHttpRequest$Builder [^ListRegionCommitmentsHttpRequest this]
    (-> this (.toBuilder))))
