(ns com.google.cloud.compute.v1.PatchHealthCheckHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 PatchHealthCheckHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.PatchHealthCheckHttpRequest`

  returns: `com.google.cloud.compute.v1.PatchHealthCheckHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.PatchHealthCheckHttpRequest$Builder [^com.google.cloud.compute.v1.PatchHealthCheckHttpRequest prototype]
    (PatchHealthCheckHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.PatchHealthCheckHttpRequest$Builder []
    (PatchHealthCheckHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.PatchHealthCheckHttpRequest`"
  (^com.google.cloud.compute.v1.PatchHealthCheckHttpRequest []
...
(defn get-user-ip
  ...
  (^java.lang.String [^PatchHealthCheckHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-health-check-resource
  ...
  (^com.google.cloud.compute.v1.HealthCheck [^PatchHealthCheckHttpRequest this]
...
(defn get-field-mask
  ...
  (^java.util.List [^PatchHealthCheckHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^PatchHealthCheckHttpRequest this ^java.lang.String field-name]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^PatchHealthCheckHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^PatchHealthCheckHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.PatchHealthCheckHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.PatchHealthCheckHttpRequest$Builder [^PatchHealthCheckHttpRequest this]
    (-> this (.toBuilder))))
