(ns com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListTargetHttpProxiesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest$Builder [^com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest prototype]
    (ListTargetHttpProxiesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest$Builder []
    (ListTargetHttpProxiesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest`"
  (^com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest []
    (ListTargetHttpProxiesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListTargetHttpProxiesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListTargetHttpProxiesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListTargetHttpProxiesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListTargetHttpProxiesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListTargetHttpProxiesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListTargetHttpProxiesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListTargetHttpProxiesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetHttpProxiesHttpRequest$Builder [^ListTargetHttpProxiesHttpRequest this]
    (-> this (.toBuilder))))
