(ns com.google.cloud.compute.v1.ListRoutersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRoutersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRoutersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRoutersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRoutersHttpRequest$Builder [^com.google.cloud.compute.v1.ListRoutersHttpRequest prototype]
    (ListRoutersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRoutersHttpRequest$Builder []
    (ListRoutersHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRoutersHttpRequest`"
  (^com.google.cloud.compute.v1.ListRoutersHttpRequest []
    (ListRoutersHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRoutersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRoutersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRoutersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRoutersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRoutersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRoutersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRoutersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRoutersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRoutersHttpRequest$Builder [^ListRoutersHttpRequest this]
    (-> this (.toBuilder))))
