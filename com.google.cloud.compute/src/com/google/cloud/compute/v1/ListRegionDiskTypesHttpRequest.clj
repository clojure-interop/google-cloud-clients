(ns com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionDiskTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest prototype]
    (ListRegionDiskTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest$Builder []
    (ListRegionDiskTypesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest`"
  (^com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest []
    (ListRegionDiskTypesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionDiskTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionDiskTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionDiskTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionDiskTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionDiskTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionDiskTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionDiskTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn get-region
  "The name of the region for this request. It must have the format
   `{project}/regions/{region}/diskTypes`. \\`{region}\\` must start with a letter, and contain only
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionDiskTypesHttpRequest$Builder [^ListRegionDiskTypesHttpRequest this]
    (-> this (.toBuilder))))
