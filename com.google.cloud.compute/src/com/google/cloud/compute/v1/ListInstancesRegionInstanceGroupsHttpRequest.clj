(ns com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInstancesRegionInstanceGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest prototype]
    (ListInstancesRegionInstanceGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInstancesRegionInstanceGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-instance-group
  ...
  (^java.lang.String [^ListInstancesRegionInstanceGroupsHttpRequest this]
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInstancesRegionInstanceGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInstancesRegionInstanceGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-region-instance-groups-list-instances-request-resource
  ...
  (^com.google.cloud.compute.v1.RegionInstanceGroupsListInstancesRequest [^ListInstancesRegionInstanceGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInstancesRegionInstanceGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInstancesRegionInstanceGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsHttpRequest$Builder [^ListInstancesRegionInstanceGroupsHttpRequest this]
    (-> this (.toBuilder))))
