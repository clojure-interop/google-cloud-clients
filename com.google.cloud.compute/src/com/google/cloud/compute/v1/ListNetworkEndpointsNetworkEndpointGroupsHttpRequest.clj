(ns com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNetworkEndpointsNetworkEndpointGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest prototype]
    (ListNetworkEndpointsNetworkEndpointGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest []
    (ListNetworkEndpointsNetworkEndpointGroupsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-network-endpoint-groups-list-endpoints-request-resource
  ...
  (^com.google.cloud.compute.v1.NetworkEndpointGroupsListEndpointsRequest [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNetworkEndpointsNetworkEndpointGroupsHttpRequest$Builder [^ListNetworkEndpointsNetworkEndpointGroupsHttpRequest this]
    (-> this (.toBuilder))))
