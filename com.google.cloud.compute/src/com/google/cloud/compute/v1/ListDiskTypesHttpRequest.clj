(ns com.google.cloud.compute.v1.ListDiskTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListDiskTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListDiskTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListDiskTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListDiskTypesHttpRequest$Builder [^com.google.cloud.compute.v1.ListDiskTypesHttpRequest prototype]
    (ListDiskTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListDiskTypesHttpRequest$Builder []
    (ListDiskTypesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListDiskTypesHttpRequest`"
  (^com.google.cloud.compute.v1.ListDiskTypesHttpRequest []
    (ListDiskTypesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListDiskTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListDiskTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListDiskTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListDiskTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListDiskTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListDiskTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListDiskTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListDiskTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListDiskTypesHttpRequest$Builder [^ListDiskTypesHttpRequest this]
    (-> this (.toBuilder))))
