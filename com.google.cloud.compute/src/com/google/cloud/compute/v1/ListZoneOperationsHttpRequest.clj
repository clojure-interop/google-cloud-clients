(ns com.google.cloud.compute.v1.ListZoneOperationsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListZoneOperationsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListZoneOperationsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListZoneOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListZoneOperationsHttpRequest$Builder [^com.google.cloud.compute.v1.ListZoneOperationsHttpRequest prototype]
    (ListZoneOperationsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListZoneOperationsHttpRequest$Builder []
    (ListZoneOperationsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListZoneOperationsHttpRequest`"
  (^com.google.cloud.compute.v1.ListZoneOperationsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListZoneOperationsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListZoneOperationsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListZoneOperationsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListZoneOperationsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListZoneOperationsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListZoneOperationsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListZoneOperationsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListZoneOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListZoneOperationsHttpRequest$Builder [^ListZoneOperationsHttpRequest this]
    (-> this (.toBuilder))))
