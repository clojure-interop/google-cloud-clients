(ns com.google.cloud.compute.v1.ListBackendBucketsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListBackendBucketsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListBackendBucketsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListBackendBucketsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListBackendBucketsHttpRequest$Builder [^com.google.cloud.compute.v1.ListBackendBucketsHttpRequest prototype]
    (ListBackendBucketsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListBackendBucketsHttpRequest$Builder []
    (ListBackendBucketsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListBackendBucketsHttpRequest`"
  (^com.google.cloud.compute.v1.ListBackendBucketsHttpRequest []
    (ListBackendBucketsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListBackendBucketsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListBackendBucketsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListBackendBucketsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListBackendBucketsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListBackendBucketsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListBackendBucketsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListBackendBucketsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListBackendBucketsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListBackendBucketsHttpRequest$Builder [^ListBackendBucketsHttpRequest this]
    (-> this (.toBuilder))))
