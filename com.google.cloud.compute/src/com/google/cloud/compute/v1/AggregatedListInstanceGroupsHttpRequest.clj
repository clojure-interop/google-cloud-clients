(ns com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListInstanceGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest prototype]
    (AggregatedListInstanceGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListInstanceGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListInstanceGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListInstanceGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListInstanceGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListInstanceGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListInstanceGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListInstanceGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListInstanceGroupsHttpRequest$Builder [^AggregatedListInstanceGroupsHttpRequest this]
    (-> this (.toBuilder))))
