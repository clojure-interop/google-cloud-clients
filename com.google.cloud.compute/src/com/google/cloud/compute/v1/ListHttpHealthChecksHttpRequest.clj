(ns com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListHttpHealthChecksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest$Builder [^com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest prototype]
    (ListHttpHealthChecksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest$Builder []
    (ListHttpHealthChecksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest`"
  (^com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest []
    (ListHttpHealthChecksHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListHttpHealthChecksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListHttpHealthChecksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListHttpHealthChecksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListHttpHealthChecksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListHttpHealthChecksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListHttpHealthChecksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListHttpHealthChecksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListHttpHealthChecksHttpRequest$Builder [^ListHttpHealthChecksHttpRequest this]
    (-> this (.toBuilder))))
