(ns com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListVpnTunnelsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest prototype]
    (AggregatedListVpnTunnelsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest []
    (AggregatedListVpnTunnelsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListVpnTunnelsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListVpnTunnelsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListVpnTunnelsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListVpnTunnelsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListVpnTunnelsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListVpnTunnelsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListVpnTunnelsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListVpnTunnelsHttpRequest$Builder [^AggregatedListVpnTunnelsHttpRequest this]
    (-> this (.toBuilder))))
