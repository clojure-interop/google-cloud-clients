(ns com.google.cloud.compute.v1.ListForwardingRulesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListForwardingRulesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListForwardingRulesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListForwardingRulesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListForwardingRulesHttpRequest$Builder [^com.google.cloud.compute.v1.ListForwardingRulesHttpRequest prototype]
    (ListForwardingRulesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListForwardingRulesHttpRequest$Builder []
    (ListForwardingRulesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListForwardingRulesHttpRequest`"
  (^com.google.cloud.compute.v1.ListForwardingRulesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListForwardingRulesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListForwardingRulesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListForwardingRulesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListForwardingRulesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListForwardingRulesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListForwardingRulesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListForwardingRulesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListForwardingRulesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListForwardingRulesHttpRequest$Builder [^ListForwardingRulesHttpRequest this]
    (-> this (.toBuilder))))
