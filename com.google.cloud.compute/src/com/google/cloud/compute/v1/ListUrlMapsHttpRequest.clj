(ns com.google.cloud.compute.v1.ListUrlMapsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListUrlMapsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListUrlMapsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListUrlMapsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListUrlMapsHttpRequest$Builder [^com.google.cloud.compute.v1.ListUrlMapsHttpRequest prototype]
    (ListUrlMapsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListUrlMapsHttpRequest$Builder []
    (ListUrlMapsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListUrlMapsHttpRequest`"
  (^com.google.cloud.compute.v1.ListUrlMapsHttpRequest []
    (ListUrlMapsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListUrlMapsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListUrlMapsHttpRequest this]
    (-> this (.getUserIp))))

(defn get-project
  "Project ID for this request. It must have the format `{project}/global/urlMaps`. \\`{project}\\`
...
(defn get-field-mask
  ...
  (^java.util.List [^ListUrlMapsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListUrlMapsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListUrlMapsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListUrlMapsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListUrlMapsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListUrlMapsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListUrlMapsHttpRequest$Builder [^ListUrlMapsHttpRequest this]
    (-> this (.toBuilder))))
