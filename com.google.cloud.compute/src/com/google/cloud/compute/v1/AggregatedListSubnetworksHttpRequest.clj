(ns com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListSubnetworksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest prototype]
    (AggregatedListSubnetworksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListSubnetworksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListSubnetworksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListSubnetworksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListSubnetworksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListSubnetworksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListSubnetworksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListSubnetworksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListSubnetworksHttpRequest$Builder [^AggregatedListSubnetworksHttpRequest this]
    (-> this (.toBuilder))))
