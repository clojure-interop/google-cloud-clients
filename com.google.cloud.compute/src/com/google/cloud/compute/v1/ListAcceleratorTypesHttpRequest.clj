(ns com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListAcceleratorTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest$Builder [^com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest prototype]
    (ListAcceleratorTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest$Builder []
    (ListAcceleratorTypesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest`"
  (^com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListAcceleratorTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListAcceleratorTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListAcceleratorTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListAcceleratorTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListAcceleratorTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListAcceleratorTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListAcceleratorTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAcceleratorTypesHttpRequest$Builder [^ListAcceleratorTypesHttpRequest this]
    (-> this (.toBuilder))))
