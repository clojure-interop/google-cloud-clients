(ns com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListVpnTunnelsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest$Builder [^com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest prototype]
    (ListVpnTunnelsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest$Builder []
    (ListVpnTunnelsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest`"
  (^com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest []
    (ListVpnTunnelsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListVpnTunnelsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListVpnTunnelsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListVpnTunnelsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListVpnTunnelsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListVpnTunnelsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListVpnTunnelsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListVpnTunnelsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListVpnTunnelsHttpRequest$Builder [^ListVpnTunnelsHttpRequest this]
    (-> this (.toBuilder))))
