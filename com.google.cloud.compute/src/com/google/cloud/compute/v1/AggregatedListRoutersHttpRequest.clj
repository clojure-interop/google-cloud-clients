(ns com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListRoutersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest prototype]
    (AggregatedListRoutersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest$Builder []
    (AggregatedListRoutersHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest`"
  (^com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest []
    (AggregatedListRoutersHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListRoutersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListRoutersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListRoutersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListRoutersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListRoutersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListRoutersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListRoutersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListRoutersHttpRequest$Builder [^AggregatedListRoutersHttpRequest this]
    (-> this (.toBuilder))))
