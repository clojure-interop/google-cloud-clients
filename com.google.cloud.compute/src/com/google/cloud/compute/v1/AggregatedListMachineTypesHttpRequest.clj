(ns com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListMachineTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest prototype]
    (AggregatedListMachineTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListMachineTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListMachineTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListMachineTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListMachineTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListMachineTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListMachineTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListMachineTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListMachineTypesHttpRequest$Builder [^AggregatedListMachineTypesHttpRequest this]
    (-> this (.toBuilder))))
