(ns com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInterconnectAttachmentsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest$Builder [^com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest prototype]
    (ListInterconnectAttachmentsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInterconnectAttachmentsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInterconnectAttachmentsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInterconnectAttachmentsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInterconnectAttachmentsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInterconnectAttachmentsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInterconnectAttachmentsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInterconnectAttachmentsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInterconnectAttachmentsHttpRequest$Builder [^ListInterconnectAttachmentsHttpRequest this]
    (-> this (.toBuilder))))
