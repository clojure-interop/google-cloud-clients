(ns com.google.cloud.compute.v1.ListMachineTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListMachineTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListMachineTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListMachineTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListMachineTypesHttpRequest$Builder [^com.google.cloud.compute.v1.ListMachineTypesHttpRequest prototype]
    (ListMachineTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListMachineTypesHttpRequest$Builder []
    (ListMachineTypesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListMachineTypesHttpRequest`"
  (^com.google.cloud.compute.v1.ListMachineTypesHttpRequest []
    (ListMachineTypesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListMachineTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListMachineTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListMachineTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListMachineTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListMachineTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListMachineTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListMachineTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListMachineTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListMachineTypesHttpRequest$Builder [^ListMachineTypesHttpRequest this]
    (-> this (.toBuilder))))
