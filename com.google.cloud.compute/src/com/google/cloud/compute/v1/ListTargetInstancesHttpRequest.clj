(ns com.google.cloud.compute.v1.ListTargetInstancesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListTargetInstancesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListTargetInstancesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListTargetInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetInstancesHttpRequest$Builder [^com.google.cloud.compute.v1.ListTargetInstancesHttpRequest prototype]
    (ListTargetInstancesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListTargetInstancesHttpRequest$Builder []
    (ListTargetInstancesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListTargetInstancesHttpRequest`"
  (^com.google.cloud.compute.v1.ListTargetInstancesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListTargetInstancesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListTargetInstancesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListTargetInstancesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListTargetInstancesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListTargetInstancesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListTargetInstancesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListTargetInstancesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListTargetInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetInstancesHttpRequest$Builder [^ListTargetInstancesHttpRequest this]
    (-> this (.toBuilder))))
