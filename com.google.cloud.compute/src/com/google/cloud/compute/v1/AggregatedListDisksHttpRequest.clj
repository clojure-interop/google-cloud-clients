(ns com.google.cloud.compute.v1.AggregatedListDisksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListDisksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListDisksHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListDisksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListDisksHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListDisksHttpRequest prototype]
    (AggregatedListDisksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListDisksHttpRequest$Builder []
    (AggregatedListDisksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.AggregatedListDisksHttpRequest`"
  (^com.google.cloud.compute.v1.AggregatedListDisksHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListDisksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListDisksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListDisksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListDisksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListDisksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListDisksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListDisksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListDisksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListDisksHttpRequest$Builder [^AggregatedListDisksHttpRequest this]
    (-> this (.toBuilder))))
