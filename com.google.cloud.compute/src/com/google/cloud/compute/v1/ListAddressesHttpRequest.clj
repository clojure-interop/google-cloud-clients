(ns com.google.cloud.compute.v1.ListAddressesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListAddressesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListAddressesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListAddressesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAddressesHttpRequest$Builder [^com.google.cloud.compute.v1.ListAddressesHttpRequest prototype]
    (ListAddressesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListAddressesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListAddressesHttpRequest []
    (ListAddressesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListAddressesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListAddressesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListAddressesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListAddressesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListAddressesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListAddressesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListAddressesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListAddressesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAddressesHttpRequest$Builder [^ListAddressesHttpRequest this]
    (-> this (.toBuilder))))
