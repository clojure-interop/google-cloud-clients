(ns com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListGlobalOperationsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest prototype]
    (AggregatedListGlobalOperationsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListGlobalOperationsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListGlobalOperationsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListGlobalOperationsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListGlobalOperationsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListGlobalOperationsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListGlobalOperationsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListGlobalOperationsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListGlobalOperationsHttpRequest$Builder [^AggregatedListGlobalOperationsHttpRequest this]
    (-> this (.toBuilder))))
