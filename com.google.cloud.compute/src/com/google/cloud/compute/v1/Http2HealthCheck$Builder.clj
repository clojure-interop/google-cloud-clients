(ns com.google.cloud.compute.v1.Http2HealthCheck$Builder
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 Http2HealthCheck$Builder]))
...
(defn get-response
  ...
  (^java.lang.String [^Http2HealthCheck$Builder this]
    (-> this (.getResponse))))
...
(defn get-port-specification
  "Specifies how port is selected for health checking, can be one of following values:
   ...
   If not specified, HTTP2 health check follows behavior specified in port and portName
   fields.
...
(defn set-port-specification
  ...
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.String port-specification]
...
(defn set-request-path
  ...
  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.String request-path]
...
(defn set-port-name
  ...
  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.String port-name]
...
(defn build
  ...
  (^com.google.cloud.compute.v1.Http2HealthCheck [^Http2HealthCheck$Builder this]
    (-> this (.build))))
...
(defn set-port
  ...
  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.Integer port]
    (-> this (.setPort port))))
...
(defn set-proxy-header
  ...
  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.String proxy-header]
    (-> this (.setProxyHeader proxy-header))))

(defn merge-from
  "other - `com.google.cloud.compute.v1.Http2HealthCheck`

  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^com.google.cloud.compute.v1.Http2HealthCheck other]
...
(defn set-host
  ...
  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.String host]
    (-> this (.setHost host))))
...
(defn set-response
  ...
  returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this ^java.lang.String response]
...
(defn get-port
  ...
  (^java.lang.Integer [^Http2HealthCheck$Builder this]
    (-> this (.getPort))))

(defn clone
  "returns: `com.google.cloud.compute.v1.Http2HealthCheck$Builder`"
  (^com.google.cloud.compute.v1.Http2HealthCheck$Builder [^Http2HealthCheck$Builder this]
    (-> this (.clone))))
