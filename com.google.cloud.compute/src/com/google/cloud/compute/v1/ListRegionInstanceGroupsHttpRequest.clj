(ns com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionInstanceGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest prototype]
    (ListRegionInstanceGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest []
    (ListRegionInstanceGroupsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionInstanceGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionInstanceGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionInstanceGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionInstanceGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionInstanceGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionInstanceGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionInstanceGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn get-region
  "Name of the region scoping this request. It must have the format
   `{project}/regions/{region}/instanceGroups`. \\`{region}\\` must start with a letter, and contain
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupsHttpRequest$Builder [^ListRegionInstanceGroupsHttpRequest this]
    (-> this (.toBuilder))))
