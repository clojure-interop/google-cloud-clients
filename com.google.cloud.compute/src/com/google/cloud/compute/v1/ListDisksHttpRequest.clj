(ns com.google.cloud.compute.v1.ListDisksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListDisksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListDisksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListDisksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListDisksHttpRequest$Builder [^com.google.cloud.compute.v1.ListDisksHttpRequest prototype]
    (ListDisksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListDisksHttpRequest$Builder []
    (ListDisksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListDisksHttpRequest`"
  (^com.google.cloud.compute.v1.ListDisksHttpRequest []
    (ListDisksHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListDisksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListDisksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListDisksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListDisksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListDisksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListDisksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListDisksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListDisksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListDisksHttpRequest$Builder [^ListDisksHttpRequest this]
    (-> this (.toBuilder))))
