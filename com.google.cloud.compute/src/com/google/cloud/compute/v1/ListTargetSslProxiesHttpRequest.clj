(ns com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListTargetSslProxiesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest$Builder [^com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest prototype]
    (ListTargetSslProxiesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest$Builder []
    (ListTargetSslProxiesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest`"
  (^com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListTargetSslProxiesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListTargetSslProxiesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListTargetSslProxiesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListTargetSslProxiesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListTargetSslProxiesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListTargetSslProxiesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListTargetSslProxiesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetSslProxiesHttpRequest$Builder [^ListTargetSslProxiesHttpRequest this]
    (-> this (.toBuilder))))
