(ns com.google.cloud.compute.v1.PatchInterconnectHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 PatchInterconnectHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.PatchInterconnectHttpRequest`

  returns: `com.google.cloud.compute.v1.PatchInterconnectHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.PatchInterconnectHttpRequest$Builder [^com.google.cloud.compute.v1.PatchInterconnectHttpRequest prototype]
    (PatchInterconnectHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.PatchInterconnectHttpRequest$Builder []
    (PatchInterconnectHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.PatchInterconnectHttpRequest`"
  (^com.google.cloud.compute.v1.PatchInterconnectHttpRequest []
...
(defn get-user-ip
  ...
  (^java.lang.String [^PatchInterconnectHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^PatchInterconnectHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^PatchInterconnectHttpRequest this ^java.lang.String field-name]
    (-> this (.getFieldValue field-name))))

(defn get-api-message-request-body
  "returns: `com.google.cloud.compute.v1.Interconnect`"
  (^com.google.cloud.compute.v1.Interconnect [^PatchInterconnectHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^PatchInterconnectHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^PatchInterconnectHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.PatchInterconnectHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.PatchInterconnectHttpRequest$Builder [^PatchInterconnectHttpRequest this]
    (-> this (.toBuilder))))
