(ns com.google.cloud.compute.v1.ListImagesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListImagesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListImagesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListImagesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListImagesHttpRequest$Builder [^com.google.cloud.compute.v1.ListImagesHttpRequest prototype]
    (ListImagesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListImagesHttpRequest$Builder []
    (ListImagesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListImagesHttpRequest`"
  (^com.google.cloud.compute.v1.ListImagesHttpRequest []
    (ListImagesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListImagesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListImagesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListImagesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListImagesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListImagesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListImagesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListImagesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListImagesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListImagesHttpRequest$Builder [^ListImagesHttpRequest this]
    (-> this (.toBuilder))))
