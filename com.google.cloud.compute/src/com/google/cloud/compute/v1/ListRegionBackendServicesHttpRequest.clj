(ns com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionBackendServicesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest prototype]
    (ListRegionBackendServicesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionBackendServicesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionBackendServicesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionBackendServicesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionBackendServicesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionBackendServicesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionBackendServicesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionBackendServicesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionBackendServicesHttpRequest$Builder [^ListRegionBackendServicesHttpRequest this]
    (-> this (.toBuilder))))
