(ns com.google.cloud.compute.v1.ListTargetPoolsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListTargetPoolsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListTargetPoolsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListTargetPoolsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetPoolsHttpRequest$Builder [^com.google.cloud.compute.v1.ListTargetPoolsHttpRequest prototype]
    (ListTargetPoolsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListTargetPoolsHttpRequest$Builder []
    (ListTargetPoolsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListTargetPoolsHttpRequest`"
  (^com.google.cloud.compute.v1.ListTargetPoolsHttpRequest []
    (ListTargetPoolsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListTargetPoolsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListTargetPoolsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListTargetPoolsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListTargetPoolsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListTargetPoolsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListTargetPoolsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListTargetPoolsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListTargetPoolsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetPoolsHttpRequest$Builder [^ListTargetPoolsHttpRequest this]
    (-> this (.toBuilder))))
