(ns com.google.cloud.compute.v1.ListNodeGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNodeGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNodeGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNodeGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodeGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListNodeGroupsHttpRequest prototype]
    (ListNodeGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNodeGroupsHttpRequest$Builder []
    (ListNodeGroupsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListNodeGroupsHttpRequest`"
  (^com.google.cloud.compute.v1.ListNodeGroupsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNodeGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNodeGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNodeGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNodeGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListNodeGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNodeGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNodeGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNodeGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodeGroupsHttpRequest$Builder [^ListNodeGroupsHttpRequest this]
    (-> this (.toBuilder))))
