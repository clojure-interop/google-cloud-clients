(ns com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListBackendServicesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest prototype]
    (AggregatedListBackendServicesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListBackendServicesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListBackendServicesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListBackendServicesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListBackendServicesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListBackendServicesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListBackendServicesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListBackendServicesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListBackendServicesHttpRequest$Builder [^AggregatedListBackendServicesHttpRequest this]
    (-> this (.toBuilder))))
