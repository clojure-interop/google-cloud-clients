(ns com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListNetworkEndpointGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest prototype]
    (AggregatedListNetworkEndpointGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest []
    (AggregatedListNetworkEndpointGroupsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListNetworkEndpointGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListNetworkEndpointGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListNetworkEndpointGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListNetworkEndpointGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListNetworkEndpointGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListNetworkEndpointGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListNetworkEndpointGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListNetworkEndpointGroupsHttpRequest$Builder [^AggregatedListNetworkEndpointGroupsHttpRequest this]
    (-> this (.toBuilder))))
