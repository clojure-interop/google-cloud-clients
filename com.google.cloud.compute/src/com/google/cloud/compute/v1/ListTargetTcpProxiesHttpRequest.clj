(ns com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListTargetTcpProxiesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest$Builder [^com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest prototype]
    (ListTargetTcpProxiesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest$Builder []
    (ListTargetTcpProxiesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest`"
  (^com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListTargetTcpProxiesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListTargetTcpProxiesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListTargetTcpProxiesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListTargetTcpProxiesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListTargetTcpProxiesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListTargetTcpProxiesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListTargetTcpProxiesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetTcpProxiesHttpRequest$Builder [^ListTargetTcpProxiesHttpRequest this]
    (-> this (.toBuilder))))
