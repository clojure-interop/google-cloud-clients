(ns com.google.cloud.compute.v1.stub.InstanceGroupManagerStubSettings$Builder
  "Builder for InstanceGroupManagerStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1.stub InstanceGroupManagerStubSettings$Builder]))
...
(defn delete-instances-instance-group-manager-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^InstanceGroupManagerStubSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.compute.v1.stub.InstanceGroupManagerStubSettings$Builder [^InstanceGroupManagerStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  "returns: `com.google.cloud.compute.v1.stub.InstanceGroupManagerStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.compute.v1.stub.InstanceGroupManagerStubSettings [^InstanceGroupManagerStubSettings$Builder this]
    (-> this (.build))))
...
(defn unary-method-settings-builders
  ...
  (^com.google.common.collect.ImmutableList [^InstanceGroupManagerStubSettings$Builder this]
...
(defn aggregated-list-instance-group-managers-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^InstanceGroupManagerStubSettings$Builder this]
