(ns com.google.cloud.compute.v1.stub.SubnetworkStubSettings$Builder
  "Builder for SubnetworkStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1.stub SubnetworkStubSettings$Builder]))
...
(defn patch-subnetwork-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^SubnetworkStubSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.compute.v1.stub.SubnetworkStubSettings$Builder [^SubnetworkStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  "returns: `com.google.cloud.compute.v1.stub.SubnetworkStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.compute.v1.stub.SubnetworkStubSettings [^SubnetworkStubSettings$Builder this]
    (-> this (.build))))
...
(defn list-subnetworks-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^SubnetworkStubSettings$Builder this]
...
(defn unary-method-settings-builders
  ...
  (^com.google.common.collect.ImmutableList [^SubnetworkStubSettings$Builder this]
