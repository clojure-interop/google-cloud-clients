(ns com.google.cloud.compute.v1.stub.VpnTunnelStubSettings
  "Settings class to configure an instance of VpnTunnelStub.
...
(defn *default-http-json-transport-provider-builder
  ...
  (^com.google.api.gax.httpjson.InstantiatingHttpJsonChannelProvider.Builder []
    (VpnTunnelStubSettings/defaultHttpJsonTransportProviderBuilder )))
...
(defn *default-executor-provider-builder
  ...
  (^com.google.api.gax.core.InstantiatingExecutorProvider.Builder []
    (VpnTunnelStubSettings/defaultExecutorProviderBuilder )))
...
(defn *get-default-endpoint
  ...
  (^java.lang.String []
    (VpnTunnelStubSettings/getDefaultEndpoint )))

(defn *default-transport-channel-provider
  "returns: `com.google.api.gax.rpc.TransportChannelProvider`"
  (^com.google.api.gax.rpc.TransportChannelProvider []
    (VpnTunnelStubSettings/defaultTransportChannelProvider )))
...
(defn *new-builder
  ...
  (^com.google.cloud.compute.v1.stub.VpnTunnelStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (VpnTunnelStubSettings/newBuilder client-context))
  (^com.google.cloud.compute.v1.stub.VpnTunnelStubSettings$Builder []
    (VpnTunnelStubSettings/newBuilder )))
...
(defn *default-credentials-provider-builder
  ...
  (^com.google.api.gax.core.GoogleCredentialsProvider.Builder []
    (VpnTunnelStubSettings/defaultCredentialsProviderBuilder )))
...
(defn *get-default-service-port
  ...
  returns: `int`"
  (^Integer []
    (VpnTunnelStubSettings/getDefaultServicePort )))

(defn *default-api-client-header-provider-builder
  "returns: `(value="The surface for customizing headers is not stable yet and may change in the future.")   com.google.api.gax.rpc.ApiClientHeaderProvider.Builder`"
  ([]
    (VpnTunnelStubSettings/defaultApiClientHeaderProviderBuilder )))
...
(defn *get-default-service-scopes
  ...
  (^java.util.List []
    (VpnTunnelStubSettings/getDefaultServiceScopes )))
...
(defn aggregated-list-vpn-tunnels-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings [^VpnTunnelStubSettings this]
...
(defn delete-vpn-tunnel-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings [^VpnTunnelStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.compute.v1.stub.VpnTunnelStubSettings$Builder`"
  (^com.google.cloud.compute.v1.stub.VpnTunnelStubSettings$Builder [^VpnTunnelStubSettings this]
    (-> this (.toBuilder))))
