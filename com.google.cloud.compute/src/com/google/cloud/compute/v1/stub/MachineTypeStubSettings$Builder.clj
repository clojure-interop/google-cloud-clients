(ns com.google.cloud.compute.v1.stub.MachineTypeStubSettings$Builder
  "Builder for MachineTypeStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1.stub MachineTypeStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.compute.v1.stub.MachineTypeStubSettings$Builder [^MachineTypeStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
    (-> this (.applyToAllUnaryMethods settings-updater))))

(defn unary-method-settings-builders
  "returns: `com.google.common.collect.ImmutableList<com.google.api.gax.rpc.UnaryCallSettings.Builder<?,?>>`"
  (^com.google.common.collect.ImmutableList [^MachineTypeStubSettings$Builder this]
...
(defn aggregated-list-machine-types-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^MachineTypeStubSettings$Builder this]
...
(defn get-machine-type-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^MachineTypeStubSettings$Builder this]
...
(defn build
  "returns: `com.google.cloud.compute.v1.stub.MachineTypeStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.compute.v1.stub.MachineTypeStubSettings [^MachineTypeStubSettings$Builder this]
    (-> this (.build))))
