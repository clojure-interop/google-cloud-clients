(ns com.google.cloud.compute.v1.stub.HttpJsonVpnTunnelCallableFactory
  "HTTP callable factory implementation for compute.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1.stub HttpJsonVpnTunnelCallableFactory]))

(defn ->http-json-vpn-tunnel-callable-factory
  "Constructor."
  (^HttpJsonVpnTunnelCallableFactory []
    (new HttpJsonVpnTunnelCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^HttpJsonVpnTunnelCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^HttpJsonVpnTunnelCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.core.BackgroundResource operations-stub]
...
(defn create-paged-callable
  ...
  ([^HttpJsonVpnTunnelCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^HttpJsonVpnTunnelCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
