(ns com.google.cloud.compute.v1.stub.ImageStubSettings
  "Settings class to configure an instance of ImageStub.
...
(defn *default-http-json-transport-provider-builder
  ...
  (^com.google.api.gax.httpjson.InstantiatingHttpJsonChannelProvider.Builder []
    (ImageStubSettings/defaultHttpJsonTransportProviderBuilder )))
...
(defn *default-executor-provider-builder
  ...
  (^com.google.api.gax.core.InstantiatingExecutorProvider.Builder []
    (ImageStubSettings/defaultExecutorProviderBuilder )))
...
(defn *get-default-endpoint
  ...
  (^java.lang.String []
    (ImageStubSettings/getDefaultEndpoint )))

(defn *default-transport-channel-provider
  "returns: `com.google.api.gax.rpc.TransportChannelProvider`"
  (^com.google.api.gax.rpc.TransportChannelProvider []
    (ImageStubSettings/defaultTransportChannelProvider )))
...
(defn *new-builder
  ...
  (^com.google.cloud.compute.v1.stub.ImageStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ImageStubSettings/newBuilder client-context))
  (^com.google.cloud.compute.v1.stub.ImageStubSettings$Builder []
    (ImageStubSettings/newBuilder )))
...
(defn *default-credentials-provider-builder
  ...
  (^com.google.api.gax.core.GoogleCredentialsProvider.Builder []
    (ImageStubSettings/defaultCredentialsProviderBuilder )))
...
(defn *get-default-service-port
  ...
  returns: `int`"
  (^Integer []
    (ImageStubSettings/getDefaultServicePort )))

(defn *default-api-client-header-provider-builder
  "returns: `(value="The surface for customizing headers is not stable yet and may change in the future.")   com.google.api.gax.rpc.ApiClientHeaderProvider.Builder`"
  ([]
    (ImageStubSettings/defaultApiClientHeaderProviderBuilder )))
...
(defn *get-default-service-scopes
  ...
  (^java.util.List []
    (ImageStubSettings/getDefaultServiceScopes )))
...
(defn set-labels-image-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings [^ImageStubSettings this]
...
(defn list-images-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings [^ImageStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.compute.v1.stub.ImageStubSettings$Builder`"
  (^com.google.cloud.compute.v1.stub.ImageStubSettings$Builder [^ImageStubSettings this]
    (-> this (.toBuilder))))
