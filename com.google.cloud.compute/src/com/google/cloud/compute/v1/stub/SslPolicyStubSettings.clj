(ns com.google.cloud.compute.v1.stub.SslPolicyStubSettings
  "Settings class to configure an instance of SslPolicyStub.
...
(defn *default-http-json-transport-provider-builder
  ...
  (^com.google.api.gax.httpjson.InstantiatingHttpJsonChannelProvider.Builder []
    (SslPolicyStubSettings/defaultHttpJsonTransportProviderBuilder )))
...
(defn *default-executor-provider-builder
  ...
  (^com.google.api.gax.core.InstantiatingExecutorProvider.Builder []
    (SslPolicyStubSettings/defaultExecutorProviderBuilder )))
...
(defn *get-default-endpoint
  ...
  (^java.lang.String []
    (SslPolicyStubSettings/getDefaultEndpoint )))

(defn *default-transport-channel-provider
  "returns: `com.google.api.gax.rpc.TransportChannelProvider`"
  (^com.google.api.gax.rpc.TransportChannelProvider []
    (SslPolicyStubSettings/defaultTransportChannelProvider )))
...
(defn *new-builder
  ...
  (^com.google.cloud.compute.v1.stub.SslPolicyStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (SslPolicyStubSettings/newBuilder client-context))
  (^com.google.cloud.compute.v1.stub.SslPolicyStubSettings$Builder []
    (SslPolicyStubSettings/newBuilder )))
...
(defn *default-credentials-provider-builder
  ...
  (^com.google.api.gax.core.GoogleCredentialsProvider.Builder []
    (SslPolicyStubSettings/defaultCredentialsProviderBuilder )))
...
(defn *get-default-service-port
  ...
  returns: `int`"
  (^Integer []
    (SslPolicyStubSettings/getDefaultServicePort )))

(defn *default-api-client-header-provider-builder
  "returns: `(value="The surface for customizing headers is not stable yet and may change in the future.")   com.google.api.gax.rpc.ApiClientHeaderProvider.Builder`"
  ([]
    (SslPolicyStubSettings/defaultApiClientHeaderProviderBuilder )))
...
(defn *get-default-service-scopes
  ...
  (^java.util.List []
    (SslPolicyStubSettings/getDefaultServiceScopes )))
...
(defn delete-ssl-policy-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings [^SslPolicyStubSettings this]
...
(defn list-ssl-policies-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings [^SslPolicyStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.compute.v1.stub.SslPolicyStubSettings$Builder`"
  (^com.google.cloud.compute.v1.stub.SslPolicyStubSettings$Builder [^SslPolicyStubSettings this]
    (-> this (.toBuilder))))
