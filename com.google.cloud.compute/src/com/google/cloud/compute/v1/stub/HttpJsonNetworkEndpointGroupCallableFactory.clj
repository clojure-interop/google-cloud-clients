(ns com.google.cloud.compute.v1.stub.HttpJsonNetworkEndpointGroupCallableFactory
  "HTTP callable factory implementation for compute.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1.stub HttpJsonNetworkEndpointGroupCallableFactory]))

(defn ->http-json-network-endpoint-group-callable-factory
  "Constructor."
  (^HttpJsonNetworkEndpointGroupCallableFactory []
    (new HttpJsonNetworkEndpointGroupCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^HttpJsonNetworkEndpointGroupCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-paged-callable
  ...
  ([^HttpJsonNetworkEndpointGroupCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^HttpJsonNetworkEndpointGroupCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
