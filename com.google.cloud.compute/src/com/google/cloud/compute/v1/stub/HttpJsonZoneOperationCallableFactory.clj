(ns com.google.cloud.compute.v1.stub.HttpJsonZoneOperationCallableFactory
...
(defn ->http-json-zone-operation-callable-factory
  "Constructor."
  (^HttpJsonZoneOperationCallableFactory []
    (new HttpJsonZoneOperationCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^HttpJsonZoneOperationCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^HttpJsonZoneOperationCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.core.BackgroundResource operations-stub]
...
(defn create-paged-callable
  ...
  ([^HttpJsonZoneOperationCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^HttpJsonZoneOperationCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
