(ns com.google.cloud.compute.v1.stub.HttpJsonForwardingRuleCallableFactory
  "HTTP callable factory implementation for compute.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1.stub HttpJsonForwardingRuleCallableFactory]))

(defn ->http-json-forwarding-rule-callable-factory
  "Constructor."
  (^HttpJsonForwardingRuleCallableFactory []
    (new HttpJsonForwardingRuleCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^HttpJsonForwardingRuleCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^HttpJsonForwardingRuleCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.core.BackgroundResource operations-stub]
...
(defn create-paged-callable
  ...
  ([^HttpJsonForwardingRuleCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^HttpJsonForwardingRuleCallableFactory this ^com.google.api.gax.httpjson.HttpJsonCallSettings http-json-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
