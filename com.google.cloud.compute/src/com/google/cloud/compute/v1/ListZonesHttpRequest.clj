(ns com.google.cloud.compute.v1.ListZonesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListZonesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListZonesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListZonesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListZonesHttpRequest$Builder [^com.google.cloud.compute.v1.ListZonesHttpRequest prototype]
    (ListZonesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListZonesHttpRequest$Builder []
    (ListZonesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListZonesHttpRequest`"
  (^com.google.cloud.compute.v1.ListZonesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListZonesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListZonesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListZonesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListZonesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListZonesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListZonesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListZonesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListZonesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListZonesHttpRequest$Builder [^ListZonesHttpRequest this]
    (-> this (.toBuilder))))
