(ns com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListReferrersInstancesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest$Builder [^com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest prototype]
    (ListReferrersInstancesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest$Builder []
    (ListReferrersInstancesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest`"
  (^com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest []
    (ListReferrersInstancesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListReferrersInstancesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListReferrersInstancesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListReferrersInstancesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListReferrersInstancesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListReferrersInstancesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListReferrersInstancesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListReferrersInstancesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListReferrersInstancesHttpRequest$Builder [^ListReferrersInstancesHttpRequest this]
    (-> this (.toBuilder))))
