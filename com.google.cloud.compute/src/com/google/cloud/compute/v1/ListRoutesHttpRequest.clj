(ns com.google.cloud.compute.v1.ListRoutesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRoutesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRoutesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRoutesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRoutesHttpRequest$Builder [^com.google.cloud.compute.v1.ListRoutesHttpRequest prototype]
    (ListRoutesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRoutesHttpRequest$Builder []
    (ListRoutesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRoutesHttpRequest`"
  (^com.google.cloud.compute.v1.ListRoutesHttpRequest []
    (ListRoutesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRoutesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRoutesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRoutesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRoutesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRoutesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRoutesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRoutesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRoutesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRoutesHttpRequest$Builder [^ListRoutesHttpRequest this]
    (-> this (.toBuilder))))
