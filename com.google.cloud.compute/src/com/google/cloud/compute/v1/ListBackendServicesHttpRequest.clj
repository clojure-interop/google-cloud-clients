(ns com.google.cloud.compute.v1.ListBackendServicesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListBackendServicesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListBackendServicesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListBackendServicesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListBackendServicesHttpRequest$Builder [^com.google.cloud.compute.v1.ListBackendServicesHttpRequest prototype]
    (ListBackendServicesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListBackendServicesHttpRequest$Builder []
    (ListBackendServicesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListBackendServicesHttpRequest`"
  (^com.google.cloud.compute.v1.ListBackendServicesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListBackendServicesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListBackendServicesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListBackendServicesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListBackendServicesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListBackendServicesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListBackendServicesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListBackendServicesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListBackendServicesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListBackendServicesHttpRequest$Builder [^ListBackendServicesHttpRequest this]
    (-> this (.toBuilder))))
