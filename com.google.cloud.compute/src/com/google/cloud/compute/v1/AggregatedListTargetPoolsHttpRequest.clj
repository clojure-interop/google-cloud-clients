(ns com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListTargetPoolsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest prototype]
    (AggregatedListTargetPoolsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListTargetPoolsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListTargetPoolsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListTargetPoolsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListTargetPoolsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListTargetPoolsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListTargetPoolsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListTargetPoolsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListTargetPoolsHttpRequest$Builder [^AggregatedListTargetPoolsHttpRequest this]
    (-> this (.toBuilder))))
