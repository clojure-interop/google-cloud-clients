(ns com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListForwardingRulesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest prototype]
    (AggregatedListForwardingRulesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListForwardingRulesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListForwardingRulesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListForwardingRulesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListForwardingRulesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListForwardingRulesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListForwardingRulesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListForwardingRulesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListForwardingRulesHttpRequest$Builder [^AggregatedListForwardingRulesHttpRequest this]
    (-> this (.toBuilder))))
