(ns com.google.cloud.compute.v1.ListLicensesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListLicensesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListLicensesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListLicensesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListLicensesHttpRequest$Builder [^com.google.cloud.compute.v1.ListLicensesHttpRequest prototype]
    (ListLicensesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListLicensesHttpRequest$Builder []
    (ListLicensesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListLicensesHttpRequest`"
  (^com.google.cloud.compute.v1.ListLicensesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListLicensesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListLicensesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListLicensesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListLicensesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListLicensesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListLicensesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListLicensesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListLicensesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListLicensesHttpRequest$Builder [^ListLicensesHttpRequest this]
    (-> this (.toBuilder))))
