(ns com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListGlobalForwardingRulesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest$Builder [^com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest prototype]
    (ListGlobalForwardingRulesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListGlobalForwardingRulesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListGlobalForwardingRulesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListGlobalForwardingRulesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListGlobalForwardingRulesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListGlobalForwardingRulesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListGlobalForwardingRulesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListGlobalForwardingRulesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListGlobalForwardingRulesHttpRequest$Builder [^ListGlobalForwardingRulesHttpRequest this]
    (-> this (.toBuilder))))
