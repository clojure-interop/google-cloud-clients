(ns com.google.cloud.compute.v1.ListSubnetworksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListSubnetworksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListSubnetworksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListSubnetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSubnetworksHttpRequest$Builder [^com.google.cloud.compute.v1.ListSubnetworksHttpRequest prototype]
    (ListSubnetworksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListSubnetworksHttpRequest$Builder []
    (ListSubnetworksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListSubnetworksHttpRequest`"
  (^com.google.cloud.compute.v1.ListSubnetworksHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListSubnetworksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListSubnetworksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListSubnetworksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListSubnetworksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListSubnetworksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListSubnetworksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListSubnetworksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListSubnetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSubnetworksHttpRequest$Builder [^ListSubnetworksHttpRequest this]
    (-> this (.toBuilder))))
