(ns com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNodesNodeGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest prototype]
    (ListNodesNodeGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest$Builder []
    (ListNodesNodeGroupsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest`"
  (^com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest []
    (ListNodesNodeGroupsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNodesNodeGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNodesNodeGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNodesNodeGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNodesNodeGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListNodesNodeGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNodesNodeGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNodesNodeGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodesNodeGroupsHttpRequest$Builder [^ListNodesNodeGroupsHttpRequest this]
    (-> this (.toBuilder))))
