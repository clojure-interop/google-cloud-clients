(ns com.google.cloud.compute.v1.ListRegionOperationsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionOperationsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionOperationsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionOperationsHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionOperationsHttpRequest prototype]
    (ListRegionOperationsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionOperationsHttpRequest$Builder []
    (ListRegionOperationsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRegionOperationsHttpRequest`"
  (^com.google.cloud.compute.v1.ListRegionOperationsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionOperationsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionOperationsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionOperationsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionOperationsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionOperationsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionOperationsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionOperationsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionOperationsHttpRequest$Builder [^ListRegionOperationsHttpRequest this]
    (-> this (.toBuilder))))
