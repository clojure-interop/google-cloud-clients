(ns com.google.cloud.compute.v1.ListInterconnectsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInterconnectsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInterconnectsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInterconnectsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInterconnectsHttpRequest$Builder [^com.google.cloud.compute.v1.ListInterconnectsHttpRequest prototype]
    (ListInterconnectsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInterconnectsHttpRequest$Builder []
    (ListInterconnectsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListInterconnectsHttpRequest`"
  (^com.google.cloud.compute.v1.ListInterconnectsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInterconnectsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInterconnectsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInterconnectsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInterconnectsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInterconnectsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInterconnectsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInterconnectsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInterconnectsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInterconnectsHttpRequest$Builder [^ListInterconnectsHttpRequest this]
    (-> this (.toBuilder))))
