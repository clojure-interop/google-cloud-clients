(ns com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListGlobalAddressesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest$Builder [^com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest prototype]
    (ListGlobalAddressesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest$Builder []
    (ListGlobalAddressesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest`"
  (^com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest []
    (ListGlobalAddressesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListGlobalAddressesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListGlobalAddressesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListGlobalAddressesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListGlobalAddressesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListGlobalAddressesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListGlobalAddressesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListGlobalAddressesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListGlobalAddressesHttpRequest$Builder [^ListGlobalAddressesHttpRequest this]
    (-> this (.toBuilder))))
