(ns com.google.cloud.compute.v1.ListRegionsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionsHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionsHttpRequest prototype]
    (ListRegionsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionsHttpRequest$Builder []
    (ListRegionsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRegionsHttpRequest`"
  (^com.google.cloud.compute.v1.ListRegionsHttpRequest []
    (ListRegionsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionsHttpRequest$Builder [^ListRegionsHttpRequest this]
    (-> this (.toBuilder))))
