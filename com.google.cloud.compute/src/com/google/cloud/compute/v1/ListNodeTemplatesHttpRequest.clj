(ns com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNodeTemplatesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest$Builder [^com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest prototype]
    (ListNodeTemplatesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest$Builder []
    (ListNodeTemplatesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest`"
  (^com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest []
    (ListNodeTemplatesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNodeTemplatesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNodeTemplatesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNodeTemplatesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNodeTemplatesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListNodeTemplatesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNodeTemplatesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNodeTemplatesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn get-region
  "The name of the region for this request. It must have the format
   `{project}/regions/{region}/nodeTemplates`. \\`{region}\\` must start with a letter, and contain
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodeTemplatesHttpRequest$Builder [^ListNodeTemplatesHttpRequest this]
    (-> this (.toBuilder))))
