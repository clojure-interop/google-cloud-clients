(ns com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListAvailableFeaturesSslPoliciesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest$Builder [^com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest prototype]
    (ListAvailableFeaturesSslPoliciesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListAvailableFeaturesSslPoliciesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListAvailableFeaturesSslPoliciesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListAvailableFeaturesSslPoliciesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListAvailableFeaturesSslPoliciesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListAvailableFeaturesSslPoliciesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListAvailableFeaturesSslPoliciesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListAvailableFeaturesSslPoliciesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListAvailableFeaturesSslPoliciesHttpRequest$Builder [^ListAvailableFeaturesSslPoliciesHttpRequest this]
    (-> this (.toBuilder))))
