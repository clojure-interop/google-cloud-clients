(ns com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionInstanceGroupManagersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest prototype]
    (ListRegionInstanceGroupManagersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionInstanceGroupManagersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionInstanceGroupManagersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionInstanceGroupManagersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionInstanceGroupManagersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionInstanceGroupManagersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionInstanceGroupManagersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionInstanceGroupManagersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionInstanceGroupManagersHttpRequest$Builder [^ListRegionInstanceGroupManagersHttpRequest this]
    (-> this (.toBuilder))))
