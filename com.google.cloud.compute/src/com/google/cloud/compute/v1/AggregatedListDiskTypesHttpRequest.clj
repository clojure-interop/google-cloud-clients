(ns com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListDiskTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest prototype]
    (AggregatedListDiskTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest$Builder []
    (AggregatedListDiskTypesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest`"
  (^com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest []
    (AggregatedListDiskTypesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListDiskTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListDiskTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListDiskTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListDiskTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListDiskTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListDiskTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListDiskTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListDiskTypesHttpRequest$Builder [^AggregatedListDiskTypesHttpRequest this]
    (-> this (.toBuilder))))
