(ns com.google.cloud.compute.v1.ListInstancesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInstancesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInstancesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstancesHttpRequest$Builder [^com.google.cloud.compute.v1.ListInstancesHttpRequest prototype]
    (ListInstancesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInstancesHttpRequest$Builder []
    (ListInstancesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListInstancesHttpRequest`"
  (^com.google.cloud.compute.v1.ListInstancesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInstancesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInstancesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInstancesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInstancesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInstancesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInstancesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInstancesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstancesHttpRequest$Builder [^ListInstancesHttpRequest this]
    (-> this (.toBuilder))))
