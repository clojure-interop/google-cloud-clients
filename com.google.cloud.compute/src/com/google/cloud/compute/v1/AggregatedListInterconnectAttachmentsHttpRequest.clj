(ns com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListInterconnectAttachmentsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest prototype]
    (AggregatedListInterconnectAttachmentsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListInterconnectAttachmentsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListInterconnectAttachmentsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListInterconnectAttachmentsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListInterconnectAttachmentsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListInterconnectAttachmentsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListInterconnectAttachmentsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListInterconnectAttachmentsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListInterconnectAttachmentsHttpRequest$Builder [^AggregatedListInterconnectAttachmentsHttpRequest this]
    (-> this (.toBuilder))))
