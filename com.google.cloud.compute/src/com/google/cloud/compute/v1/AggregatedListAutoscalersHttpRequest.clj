(ns com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListAutoscalersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest prototype]
    (AggregatedListAutoscalersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListAutoscalersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListAutoscalersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListAutoscalersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListAutoscalersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListAutoscalersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListAutoscalersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListAutoscalersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListAutoscalersHttpRequest$Builder [^AggregatedListAutoscalersHttpRequest this]
    (-> this (.toBuilder))))
