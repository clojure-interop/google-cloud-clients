(ns com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListInstancesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest prototype]
    (AggregatedListInstancesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest$Builder []
    (AggregatedListInstancesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest`"
  (^com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListInstancesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListInstancesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListInstancesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListInstancesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListInstancesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListInstancesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListInstancesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListInstancesHttpRequest$Builder [^AggregatedListInstancesHttpRequest this]
    (-> this (.toBuilder))))
