(ns com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListNodeGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest prototype]
    (AggregatedListNodeGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListNodeGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListNodeGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListNodeGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListNodeGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListNodeGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListNodeGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListNodeGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListNodeGroupsHttpRequest$Builder [^AggregatedListNodeGroupsHttpRequest this]
    (-> this (.toBuilder))))
