(ns com.google.cloud.compute.v1.ListHealthChecksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListHealthChecksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListHealthChecksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListHealthChecksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListHealthChecksHttpRequest$Builder [^com.google.cloud.compute.v1.ListHealthChecksHttpRequest prototype]
    (ListHealthChecksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListHealthChecksHttpRequest$Builder []
    (ListHealthChecksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListHealthChecksHttpRequest`"
  (^com.google.cloud.compute.v1.ListHealthChecksHttpRequest []
    (ListHealthChecksHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListHealthChecksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListHealthChecksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListHealthChecksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListHealthChecksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListHealthChecksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListHealthChecksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListHealthChecksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListHealthChecksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListHealthChecksHttpRequest$Builder [^ListHealthChecksHttpRequest this]
    (-> this (.toBuilder))))
