(ns com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNetworkEndpointGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest prototype]
    (ListNetworkEndpointGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest []
    (ListNetworkEndpointGroupsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNetworkEndpointGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNetworkEndpointGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNetworkEndpointGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNetworkEndpointGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListNetworkEndpointGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNetworkEndpointGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNetworkEndpointGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNetworkEndpointGroupsHttpRequest$Builder [^ListNetworkEndpointGroupsHttpRequest this]
    (-> this (.toBuilder))))
