(ns com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 InsertRegionAutoscalerHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest`

  returns: `com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest$Builder [^com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest prototype]
    (InsertRegionAutoscalerHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest$Builder []
    (InsertRegionAutoscalerHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest`"
  (^com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest []
    (InsertRegionAutoscalerHttpRequest/getDefaultInstance )))

(defn get-user-ip
  "IP address of the end user for whom the API call is being made.

  returns: `java.lang.String`"
  (^java.lang.String [^InsertRegionAutoscalerHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-autoscaler-resource
  ...
  (^com.google.cloud.compute.v1.Autoscaler [^InsertRegionAutoscalerHttpRequest this]
...
(defn get-field-mask
  ...
  (^java.util.List [^InsertRegionAutoscalerHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^InsertRegionAutoscalerHttpRequest this ^java.lang.String field-name]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^InsertRegionAutoscalerHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^InsertRegionAutoscalerHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.InsertRegionAutoscalerHttpRequest$Builder [^InsertRegionAutoscalerHttpRequest this]
    (-> this (.toBuilder))))
