(ns com.google.cloud.compute.v1.ListRegionDisksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionDisksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionDisksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionDisksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionDisksHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionDisksHttpRequest prototype]
    (ListRegionDisksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionDisksHttpRequest$Builder []
    (ListRegionDisksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRegionDisksHttpRequest`"
  (^com.google.cloud.compute.v1.ListRegionDisksHttpRequest []
    (ListRegionDisksHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionDisksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionDisksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionDisksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionDisksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionDisksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionDisksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionDisksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionDisksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionDisksHttpRequest$Builder [^ListRegionDisksHttpRequest this]
    (-> this (.toBuilder))))
