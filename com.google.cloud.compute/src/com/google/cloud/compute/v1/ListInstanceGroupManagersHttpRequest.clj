(ns com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInstanceGroupManagersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest$Builder [^com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest prototype]
    (ListInstanceGroupManagersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest []
    (ListInstanceGroupManagersHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInstanceGroupManagersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInstanceGroupManagersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInstanceGroupManagersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInstanceGroupManagersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInstanceGroupManagersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInstanceGroupManagersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInstanceGroupManagersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstanceGroupManagersHttpRequest$Builder [^ListInstanceGroupManagersHttpRequest this]
    (-> this (.toBuilder))))
