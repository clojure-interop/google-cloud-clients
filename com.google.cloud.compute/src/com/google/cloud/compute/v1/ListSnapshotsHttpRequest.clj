(ns com.google.cloud.compute.v1.ListSnapshotsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListSnapshotsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListSnapshotsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListSnapshotsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSnapshotsHttpRequest$Builder [^com.google.cloud.compute.v1.ListSnapshotsHttpRequest prototype]
    (ListSnapshotsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListSnapshotsHttpRequest$Builder []
    (ListSnapshotsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListSnapshotsHttpRequest`"
  (^com.google.cloud.compute.v1.ListSnapshotsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListSnapshotsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListSnapshotsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListSnapshotsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListSnapshotsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListSnapshotsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListSnapshotsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListSnapshotsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListSnapshotsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSnapshotsHttpRequest$Builder [^ListSnapshotsHttpRequest this]
    (-> this (.toBuilder))))
