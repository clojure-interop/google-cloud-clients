(ns com.google.cloud.compute.v1.ListSslCertificatesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListSslCertificatesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListSslCertificatesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListSslCertificatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSslCertificatesHttpRequest$Builder [^com.google.cloud.compute.v1.ListSslCertificatesHttpRequest prototype]
    (ListSslCertificatesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListSslCertificatesHttpRequest$Builder []
    (ListSslCertificatesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListSslCertificatesHttpRequest`"
  (^com.google.cloud.compute.v1.ListSslCertificatesHttpRequest []
    (ListSslCertificatesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListSslCertificatesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListSslCertificatesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListSslCertificatesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListSslCertificatesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListSslCertificatesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListSslCertificatesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListSslCertificatesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListSslCertificatesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSslCertificatesHttpRequest$Builder [^ListSslCertificatesHttpRequest this]
    (-> this (.toBuilder))))
