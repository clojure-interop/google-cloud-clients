(ns com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInstanceGroupsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest$Builder [^com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest prototype]
    (ListInstanceGroupsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest$Builder []
    (ListInstanceGroupsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest`"
  (^com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest []
    (ListInstanceGroupsHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInstanceGroupsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInstanceGroupsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInstanceGroupsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInstanceGroupsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInstanceGroupsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInstanceGroupsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInstanceGroupsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInstanceGroupsHttpRequest$Builder [^ListInstanceGroupsHttpRequest this]
    (-> this (.toBuilder))))
