(ns com.google.cloud.compute.v1.ListNodeTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNodeTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNodeTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNodeTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodeTypesHttpRequest$Builder [^com.google.cloud.compute.v1.ListNodeTypesHttpRequest prototype]
    (ListNodeTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNodeTypesHttpRequest$Builder []
    (ListNodeTypesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListNodeTypesHttpRequest`"
  (^com.google.cloud.compute.v1.ListNodeTypesHttpRequest []
    (ListNodeTypesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNodeTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNodeTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNodeTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNodeTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListNodeTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNodeTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNodeTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNodeTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNodeTypesHttpRequest$Builder [^ListNodeTypesHttpRequest this]
    (-> this (.toBuilder))))
