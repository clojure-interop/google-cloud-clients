(ns com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListInterconnectLocationsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest$Builder [^com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest prototype]
    (ListInterconnectLocationsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListInterconnectLocationsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListInterconnectLocationsHttpRequest this]
    (-> this (.getUserIp))))

(defn get-project
  "Project ID for this request. It must have the format `{project}/global/interconnectLocations`.
...
(defn get-field-mask
  ...
  (^java.util.List [^ListInterconnectLocationsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListInterconnectLocationsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListInterconnectLocationsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListInterconnectLocationsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListInterconnectLocationsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListInterconnectLocationsHttpRequest$Builder [^ListInterconnectLocationsHttpRequest this]
    (-> this (.toBuilder))))
