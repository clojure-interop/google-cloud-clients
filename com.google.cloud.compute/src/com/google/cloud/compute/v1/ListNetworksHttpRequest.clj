(ns com.google.cloud.compute.v1.ListNetworksHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListNetworksHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListNetworksHttpRequest`

  returns: `com.google.cloud.compute.v1.ListNetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNetworksHttpRequest$Builder [^com.google.cloud.compute.v1.ListNetworksHttpRequest prototype]
    (ListNetworksHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListNetworksHttpRequest$Builder []
    (ListNetworksHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListNetworksHttpRequest`"
  (^com.google.cloud.compute.v1.ListNetworksHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListNetworksHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListNetworksHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListNetworksHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListNetworksHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListNetworksHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListNetworksHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListNetworksHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListNetworksHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListNetworksHttpRequest$Builder [^ListNetworksHttpRequest this]
    (-> this (.toBuilder))))
