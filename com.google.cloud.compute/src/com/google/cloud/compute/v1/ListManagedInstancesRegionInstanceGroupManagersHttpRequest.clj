(ns com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListManagedInstancesRegionInstanceGroupManagersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest$Builder [^com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest prototype]
    (ListManagedInstancesRegionInstanceGroupManagersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest []
    (ListManagedInstancesRegionInstanceGroupManagersHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersHttpRequest$Builder [^ListManagedInstancesRegionInstanceGroupManagersHttpRequest this]
    (-> this (.toBuilder))))
