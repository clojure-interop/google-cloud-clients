(ns com.google.cloud.compute.v1.ListFirewallsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListFirewallsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListFirewallsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListFirewallsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListFirewallsHttpRequest$Builder [^com.google.cloud.compute.v1.ListFirewallsHttpRequest prototype]
    (ListFirewallsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListFirewallsHttpRequest$Builder []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListFirewallsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListFirewallsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListFirewallsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListFirewallsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListFirewallsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListFirewallsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListFirewallsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListFirewallsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListFirewallsHttpRequest$Builder [^ListFirewallsHttpRequest this]
    (-> this (.toBuilder))))
