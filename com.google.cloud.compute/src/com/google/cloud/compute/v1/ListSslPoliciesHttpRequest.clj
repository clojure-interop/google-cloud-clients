(ns com.google.cloud.compute.v1.ListSslPoliciesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListSslPoliciesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListSslPoliciesHttpRequest`

  returns: `com.google.cloud.compute.v1.ListSslPoliciesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSslPoliciesHttpRequest$Builder [^com.google.cloud.compute.v1.ListSslPoliciesHttpRequest prototype]
    (ListSslPoliciesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListSslPoliciesHttpRequest$Builder []
    (ListSslPoliciesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListSslPoliciesHttpRequest`"
  (^com.google.cloud.compute.v1.ListSslPoliciesHttpRequest []
    (ListSslPoliciesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListSslPoliciesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListSslPoliciesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListSslPoliciesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListSslPoliciesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListSslPoliciesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListSslPoliciesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListSslPoliciesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListSslPoliciesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListSslPoliciesHttpRequest$Builder [^ListSslPoliciesHttpRequest this]
    (-> this (.toBuilder))))
