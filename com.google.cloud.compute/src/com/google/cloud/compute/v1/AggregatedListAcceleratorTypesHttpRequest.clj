(ns com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListAcceleratorTypesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest prototype]
    (AggregatedListAcceleratorTypesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListAcceleratorTypesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListAcceleratorTypesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListAcceleratorTypesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListAcceleratorTypesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListAcceleratorTypesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListAcceleratorTypesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListAcceleratorTypesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListAcceleratorTypesHttpRequest$Builder [^AggregatedListAcceleratorTypesHttpRequest this]
    (-> this (.toBuilder))))
