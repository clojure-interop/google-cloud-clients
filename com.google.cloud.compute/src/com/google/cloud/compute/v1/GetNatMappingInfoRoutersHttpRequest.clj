(ns com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 GetNatMappingInfoRoutersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest`

  returns: `com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest$Builder [^com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest prototype]
    (GetNatMappingInfoRoutersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^GetNatMappingInfoRoutersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^GetNatMappingInfoRoutersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^GetNatMappingInfoRoutersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^GetNatMappingInfoRoutersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^GetNatMappingInfoRoutersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^GetNatMappingInfoRoutersHttpRequest this]
    (-> this (.hashCode))))
...
(defn get-router
  "Name of the Router resource to query for Nat Mapping information of VM endpoints. It must have
   the format `{project}/regions/{region}/routers/{router}/getNatMappingInfo`. \\`{router}\\` must
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^GetNatMappingInfoRoutersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.GetNatMappingInfoRoutersHttpRequest$Builder [^GetNatMappingInfoRoutersHttpRequest this]
    (-> this (.toBuilder))))
