(ns com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListRegionCommitmentsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest prototype]
    (AggregatedListRegionCommitmentsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest$Builder []
...
(defn *get-default-instance
  ...
  (^com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListRegionCommitmentsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListRegionCommitmentsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListRegionCommitmentsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListRegionCommitmentsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListRegionCommitmentsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListRegionCommitmentsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListRegionCommitmentsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListRegionCommitmentsHttpRequest$Builder [^AggregatedListRegionCommitmentsHttpRequest this]
    (-> this (.toBuilder))))
