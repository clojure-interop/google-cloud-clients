(ns com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 AggregatedListAddressesHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest`

  returns: `com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest$Builder [^com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest prototype]
    (AggregatedListAddressesHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest$Builder []
    (AggregatedListAddressesHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest`"
  (^com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest []
    (AggregatedListAddressesHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^AggregatedListAddressesHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^AggregatedListAddressesHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^AggregatedListAddressesHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^AggregatedListAddressesHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^AggregatedListAddressesHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^AggregatedListAddressesHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^AggregatedListAddressesHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.AggregatedListAddressesHttpRequest$Builder [^AggregatedListAddressesHttpRequest this]
    (-> this (.toBuilder))))
