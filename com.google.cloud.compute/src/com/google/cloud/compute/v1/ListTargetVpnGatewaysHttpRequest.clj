(ns com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListTargetVpnGatewaysHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest`

  returns: `com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest$Builder [^com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest prototype]
    (ListTargetVpnGatewaysHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest$Builder []
    (ListTargetVpnGatewaysHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest`"
  (^com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest []
    (ListTargetVpnGatewaysHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListTargetVpnGatewaysHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListTargetVpnGatewaysHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListTargetVpnGatewaysHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListTargetVpnGatewaysHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListTargetVpnGatewaysHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListTargetVpnGatewaysHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListTargetVpnGatewaysHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListTargetVpnGatewaysHttpRequest$Builder [^ListTargetVpnGatewaysHttpRequest this]
    (-> this (.toBuilder))))
