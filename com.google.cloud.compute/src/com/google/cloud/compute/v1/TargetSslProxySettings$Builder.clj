(ns com.google.cloud.compute.v1.TargetSslProxySettings$Builder
  "Builder for TargetSslProxySettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 TargetSslProxySettings$Builder]))
...
(defn set-ssl-policy-target-ssl-proxy-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^TargetSslProxySettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.compute.v1.TargetSslProxySettings$Builder [^TargetSslProxySettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  ...
  (^com.google.cloud.compute.v1.TargetSslProxySettings [^TargetSslProxySettings$Builder this]
    (-> this (.build))))
...
(defn get-stub-settings-builder
  ...
  (^com.google.cloud.compute.v1.stub.TargetSslProxyStubSettings$Builder [^TargetSslProxySettings$Builder this]
...
(defn list-target-ssl-proxies-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings.Builder [^TargetSslProxySettings$Builder this]
