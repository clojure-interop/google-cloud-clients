(ns com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListRegionAutoscalersHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest`

  returns: `com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest$Builder [^com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest prototype]
    (ListRegionAutoscalersHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest$Builder []
    (ListRegionAutoscalersHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest`"
  (^com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest []
    (ListRegionAutoscalersHttpRequest/getDefaultInstance )))
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListRegionAutoscalersHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListRegionAutoscalersHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListRegionAutoscalersHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListRegionAutoscalersHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListRegionAutoscalersHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListRegionAutoscalersHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListRegionAutoscalersHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListRegionAutoscalersHttpRequest$Builder [^ListRegionAutoscalersHttpRequest this]
    (-> this (.toBuilder))))
