(ns com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.compute.v1 ListGlobalOperationsHttpRequest]))

(defn *new-builder
  "prototype - `com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest`

  returns: `com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest$Builder [^com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest prototype]
    (ListGlobalOperationsHttpRequest/newBuilder prototype))
  (^com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest$Builder []
    (ListGlobalOperationsHttpRequest/newBuilder )))

(defn *get-default-instance
  "returns: `com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest`"
  (^com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest []
...
(defn get-max-results
  ...
  (^java.lang.Integer [^ListGlobalOperationsHttpRequest this]
    (-> this (.getMaxResults))))
...
(defn get-user-ip
  ...
  (^java.lang.String [^ListGlobalOperationsHttpRequest this]
    (-> this (.getUserIp))))
...
(defn get-field-mask
  ...
  (^java.util.List [^ListGlobalOperationsHttpRequest this]
    (-> this (.getFieldMask))))
...
(defn get-field-value
  ...
  (^java.lang.Object [^ListGlobalOperationsHttpRequest this ^java.lang.String field-name]
...
(defn get-api-message-request-body
  ...
  (^com.google.api.gax.httpjson.ApiMessage [^ListGlobalOperationsHttpRequest this]
...
(defn hash-code
  "returns: `int`"
  (^Integer [^ListGlobalOperationsHttpRequest this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  returns: `boolean`"
  (^Boolean [^ListGlobalOperationsHttpRequest this ^java.lang.Object o]
    (-> this (.equals o))))

(defn to-builder
  "returns: `com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest$Builder`"
  (^com.google.cloud.compute.v1.ListGlobalOperationsHttpRequest$Builder [^ListGlobalOperationsHttpRequest this]
    (-> this (.toBuilder))))
