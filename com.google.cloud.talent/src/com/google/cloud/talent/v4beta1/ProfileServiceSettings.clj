(ns com.google.cloud.talent.v4beta1.ProfileServiceSettings
...
(defn *default-executor-provider-builder
  ...
  (^com.google.api.gax.core.InstantiatingExecutorProvider.Builder []
    (ProfileServiceSettings/defaultExecutorProviderBuilder )))
...
(defn *get-default-endpoint
  ...
  (^java.lang.String []
    (ProfileServiceSettings/getDefaultEndpoint )))

(defn *default-transport-channel-provider
  "returns: `com.google.api.gax.rpc.TransportChannelProvider`"
  (^com.google.api.gax.rpc.TransportChannelProvider []
    (ProfileServiceSettings/defaultTransportChannelProvider )))
...
(defn *new-builder
  ...
  (^com.google.cloud.talent.v4beta1.ProfileServiceSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ProfileServiceSettings/newBuilder client-context))
  (^com.google.cloud.talent.v4beta1.ProfileServiceSettings$Builder []
    (ProfileServiceSettings/newBuilder )))
...
(defn *default-credentials-provider-builder
  ...
  (^com.google.api.gax.core.GoogleCredentialsProvider.Builder []
    (ProfileServiceSettings/defaultCredentialsProviderBuilder )))

(defn *create
  "stub - `com.google.cloud.talent.v4beta1.stub.ProfileServiceStubSettings`

  returns: `com.google.cloud.talent.v4beta1.ProfileServiceSettings`

  throws: java.io.IOException"
  (^com.google.cloud.talent.v4beta1.ProfileServiceSettings [^com.google.cloud.talent.v4beta1.stub.ProfileServiceStubSettings stub]
    (ProfileServiceSettings/create stub)))
...
(defn *default-grpc-transport-provider-builder
  ...
  (^com.google.api.gax.grpc.InstantiatingGrpcChannelProvider.Builder []
    (ProfileServiceSettings/defaultGrpcTransportProviderBuilder )))

(defn *default-api-client-header-provider-builder
  "returns: `(value="The surface for customizing headers is not stable yet and may change in the future.")   com.google.api.gax.rpc.ApiClientHeaderProvider.Builder`"
  ([]
    (ProfileServiceSettings/defaultApiClientHeaderProviderBuilder )))
...
(defn *get-default-service-scopes
  ...
  (^java.util.List []
    (ProfileServiceSettings/getDefaultServiceScopes )))
...
(defn list-profiles-settings
  ...
  (^com.google.api.gax.rpc.PagedCallSettings [^ProfileServiceSettings this]
...
(defn create-profile-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings [^ProfileServiceSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.talent.v4beta1.ProfileServiceSettings$Builder`"
  (^com.google.cloud.talent.v4beta1.ProfileServiceSettings$Builder [^ProfileServiceSettings this]
    (-> this (.toBuilder))))
