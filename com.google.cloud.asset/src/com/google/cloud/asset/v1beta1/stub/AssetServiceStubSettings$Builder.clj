(ns com.google.cloud.asset.v1beta1.stub.AssetServiceStubSettings$Builder
  "Builder for AssetServiceStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.asset.v1beta1.stub AssetServiceStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.asset.v1beta1.stub.AssetServiceStubSettings$Builder [^AssetServiceStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn export-assets-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.asset.v1beta1.ExportAssetsRequest,com.google.cloud.asset.v1beta1.ExportAssetsResponse,com.google.cloud.asset.v1beta1.ExportAssetsRequest>`"
...
(defn build
  "returns: `com.google.cloud.asset.v1beta1.stub.AssetServiceStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.asset.v1beta1.stub.AssetServiceStubSettings [^AssetServiceStubSettings$Builder this]
    (-> this (.build))))
