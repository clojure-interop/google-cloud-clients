(ns com.google.cloud.asset.v1beta1.stub.GrpcAssetServiceStub
  "gRPC stub implementation for Cloud Asset API.

  This class is for advanced usage and reflects the underlying API directly."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.asset.v1beta1.stub GrpcAssetServiceStub]))

(defn *create
  "client-context - `com.google.api.gax.rpc.ClientContext`
  callable-factory - `com.google.api.gax.grpc.GrpcStubCallableFactory`

  returns: `com.google.cloud.asset.v1beta1.stub.GrpcAssetServiceStub`

  throws: java.io.IOException"
  (^com.google.cloud.asset.v1beta1.stub.GrpcAssetServiceStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcAssetServiceStub/create client-context callable-factory))
  (^com.google.cloud.asset.v1beta1.stub.GrpcAssetServiceStub [^com.google.cloud.asset.v1beta1.stub.AssetServiceStubSettings settings]
