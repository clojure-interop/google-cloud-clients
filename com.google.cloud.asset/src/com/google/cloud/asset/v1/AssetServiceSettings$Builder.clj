(ns com.google.cloud.asset.v1.AssetServiceSettings$Builder
  "Builder for AssetServiceSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.asset.v1 AssetServiceSettings$Builder]))

(defn get-stub-settings-builder
  "returns: `com.google.cloud.asset.v1.stub.AssetServiceStubSettings$Builder`"
  (^com.google.cloud.asset.v1.stub.AssetServiceStubSettings$Builder [^AssetServiceSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.asset.v1.AssetServiceSettings$Builder [^AssetServiceSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn export-assets-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.asset.v1.ExportAssetsRequest,com.google.cloud.asset.v1.ExportAssetsResponse,com.google.cloud.asset.v1.ExportAssetsRequest>`"
...
(defn build
  ...
  (^com.google.cloud.asset.v1.AssetServiceSettings [^AssetServiceSettings$Builder this]
    (-> this (.build))))
