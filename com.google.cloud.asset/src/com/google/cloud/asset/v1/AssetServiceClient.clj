(ns com.google.cloud.asset.v1.AssetServiceClient
...
(defn *create
  ...
  settings - `com.google.cloud.asset.v1.AssetServiceSettings`

  returns: `com.google.cloud.asset.v1.AssetServiceClient`

  throws: java.io.IOException"
  (^com.google.cloud.asset.v1.AssetServiceClient [^com.google.cloud.asset.v1.AssetServiceSettings settings]
...
(defn export-assets-async
  ...
  request - The request object containing all of the parameters for the API call. - `com.google.cloud.asset.v1.ExportAssetsRequest`

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.cloud.asset.v1.ExportAssetsResponse,com.google.cloud.asset.v1.ExportAssetsRequest>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^AssetServiceClient this ^com.google.cloud.asset.v1.ExportAssetsRequest request]
...
(defn get-settings
  ...
  (^com.google.cloud.asset.v1.AssetServiceSettings [^AssetServiceClient this]
    (-> this (.getSettings))))
...
(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.asset.v1.stub.AssetServiceStub`"
  ([^AssetServiceClient this]
    (-> this (.getStub))))
...
(defn batch-get-assets-history
  ...
  request - The request object containing all of the parameters for the API call. - `com.google.cloud.asset.v1.BatchGetAssetsHistoryRequest`

  returns: `com.google.cloud.asset.v1.BatchGetAssetsHistoryResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.asset.v1.BatchGetAssetsHistoryResponse [^AssetServiceClient this ^com.google.cloud.asset.v1.BatchGetAssetsHistoryRequest request]
