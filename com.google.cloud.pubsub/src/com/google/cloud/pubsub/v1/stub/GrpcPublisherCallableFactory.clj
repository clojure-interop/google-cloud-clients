(ns com.google.cloud.pubsub.v1.stub.GrpcPublisherCallableFactory
...
(defn ->grpc-publisher-callable-factory
  "Constructor."
  (^GrpcPublisherCallableFactory []
    (new GrpcPublisherCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^GrpcPublisherCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-paged-callable
  ...
  ([^GrpcPublisherCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^GrpcPublisherCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^GrpcPublisherCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.longrunning.stub.OperationsStub operations-stub]
...
(defn create-bidi-streaming-callable
  ...
  ([^GrpcPublisherCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.StreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-server-streaming-callable
  ...
  ([^GrpcPublisherCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.ServerStreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
