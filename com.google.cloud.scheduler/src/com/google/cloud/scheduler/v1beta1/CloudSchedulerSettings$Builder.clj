(ns com.google.cloud.scheduler.v1beta1.CloudSchedulerSettings$Builder
  "Builder for CloudSchedulerSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.scheduler.v1beta1 CloudSchedulerSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  returns: `com.google.cloud.scheduler.v1beta1.CloudSchedulerSettings$Builder`

  throws: java.lang.Exception"
  (^com.google.cloud.scheduler.v1beta1.CloudSchedulerSettings$Builder [^CloudSchedulerSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  ...
  (^com.google.cloud.scheduler.v1beta1.CloudSchedulerSettings [^CloudSchedulerSettings$Builder this]
    (-> this (.build))))

(defn get-stub-settings-builder
  "returns: `com.google.cloud.scheduler.v1beta1.stub.CloudSchedulerStubSettings$Builder`"
  (^com.google.cloud.scheduler.v1beta1.stub.CloudSchedulerStubSettings$Builder [^CloudSchedulerSettings$Builder this]
