(ns com.google.cloud.container.v1.ClusterManagerSettings$Builder
  "Builder for ClusterManagerSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.container.v1 ClusterManagerSettings$Builder]))
...
(defn get-operation-settings
  ...
  (^com.google.api.gax.rpc.UnaryCallSettings.Builder [^ClusterManagerSettings$Builder this]
...
(defn apply-to-all-unary-methods
  ...
  returns: `com.google.cloud.container.v1.ClusterManagerSettings$Builder`

  throws: java.lang.Exception"
  (^com.google.cloud.container.v1.ClusterManagerSettings$Builder [^ClusterManagerSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
...
(defn build
  ...
  (^com.google.cloud.container.v1.ClusterManagerSettings [^ClusterManagerSettings$Builder this]
    (-> this (.build))))
...
(defn get-stub-settings-builder
  ...
  (^com.google.cloud.container.v1.stub.ClusterManagerStubSettings$Builder [^ClusterManagerSettings$Builder this]
