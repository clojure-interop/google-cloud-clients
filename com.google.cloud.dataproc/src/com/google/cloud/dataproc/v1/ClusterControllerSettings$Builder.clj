(ns com.google.cloud.dataproc.v1.ClusterControllerSettings$Builder
  "Builder for ClusterControllerSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dataproc.v1 ClusterControllerSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dataproc.v1.ClusterControllerSettings$Builder [^ClusterControllerSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
    (-> this (.applyToAllUnaryMethods settings-updater))))

(defn create-cluster-operation-settings
  "Returns the builder for the settings used for calls to createCluster.

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1.CreateClusterRequest,com.google.cloud.dataproc.v1.Cluster,com.google.cloud.dataproc.v1.ClusterOperationMetadata>`"
...
(defn delete-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1.DeleteClusterRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1.ClusterOperationMetadata>`"
  ([^ClusterControllerSettings$Builder this]
...
(defn diagnose-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1.DiagnoseClusterRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1.DiagnoseClusterResults>`"
  ([^ClusterControllerSettings$Builder this]
...
(defn build
  ...
  (^com.google.cloud.dataproc.v1.ClusterControllerSettings [^ClusterControllerSettings$Builder this]
    (-> this (.build))))
...
(defn update-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1.UpdateClusterRequest,com.google.cloud.dataproc.v1.Cluster,com.google.cloud.dataproc.v1.ClusterOperationMetadata>`"
  ([^ClusterControllerSettings$Builder this]
    (-> this (.updateClusterOperationSettings))))

(defn get-stub-settings-builder
  "returns: `com.google.cloud.dataproc.v1.stub.ClusterControllerStubSettings$Builder`"
  (^com.google.cloud.dataproc.v1.stub.ClusterControllerStubSettings$Builder [^ClusterControllerSettings$Builder this]
