(ns com.google.cloud.dataproc.v1.WorkflowTemplateServiceClient
...
(defn *create
  ...
  settings - `com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings`

  returns: `com.google.cloud.dataproc.v1.WorkflowTemplateServiceClient`

  throws: java.io.IOException"
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceClient [^com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings settings]
...
(defn get-settings
  ...
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings [^WorkflowTemplateServiceClient this]
    (-> this (.getSettings))))
...
(defn create-workflow-template
  ...
  parent - Required. The \"resource name\" of the region, as described in https://cloud.google.com/apis/design/resource_names of the form `projects/{project_id}/regions/{region}` - `com.google.cloud.dataproc.v1.RegionName`
  template - Required. The Dataproc workflow template to create. - `com.google.cloud.dataproc.v1.WorkflowTemplate`

  returns: `com.google.cloud.dataproc.v1.WorkflowTemplate`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dataproc.v1.WorkflowTemplate [^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.RegionName parent ^com.google.cloud.dataproc.v1.WorkflowTemplate template]
    (-> this (.createWorkflowTemplate parent template)))
  (^com.google.cloud.dataproc.v1.WorkflowTemplate [^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.CreateWorkflowTemplateRequest request]
...
(defn get-stub
  "returns: `(value="A restructuring of stub classes is planned, so this may break in the future")  com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStub`"
  ([^WorkflowTemplateServiceClient this]
    (-> this (.getStub))))
...
(defn instantiate-workflow-template-async
  ...
  name - Required. The \"resource name\" of the workflow template, as described in https://cloud.google.com/apis/design/resource_names of the form `projects/{project_id}/regions/{region}/workflowTemplates/{template_id}` - `com.google.cloud.dataproc.v1.WorkflowTemplateName`
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.protobuf.Empty,com.google.cloud.dataproc.v1.WorkflowMetadata>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.WorkflowTemplateName name ^java.util.Map parameters]
    (-> this (.instantiateWorkflowTemplateAsync name parameters)))
  ([^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.WorkflowTemplateName name]
...
(defn list-workflow-templates
  ...
  returns: `com.google.cloud.dataproc.v1.WorkflowTemplateServiceClient$ListWorkflowTemplatesPagedResponse`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceClient$ListWorkflowTemplatesPagedResponse [^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.RegionName parent]
...
(defn update-workflow-template
  ...
  template - Required. The updated workflow template. The `template.version` field must match the current version. - `com.google.cloud.dataproc.v1.WorkflowTemplate`

  returns: `com.google.cloud.dataproc.v1.WorkflowTemplate`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dataproc.v1.WorkflowTemplate [^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.WorkflowTemplate template]
...
(defn get-workflow-template
  ...
  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  (^com.google.cloud.dataproc.v1.WorkflowTemplate [^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.WorkflowTemplateName name]
...
(defn instantiate-inline-workflow-template-async
  ...
  parent - Required. The \"resource name\" of the workflow template region, as described in https://cloud.google.com/apis/design/resource_names of the form `projects/{project_id}/regions/{region}` - `com.google.cloud.dataproc.v1.RegionName`
  template - Required. The workflow template to instantiate. - `com.google.cloud.dataproc.v1.WorkflowTemplate`

  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")   com.google.api.gax.longrunning.OperationFuture<com.google.protobuf.Empty,com.google.cloud.dataproc.v1.WorkflowMetadata>`

  throws: com.google.api.gax.rpc.ApiException - if the remote call fails"
  ([^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.RegionName parent ^com.google.cloud.dataproc.v1.WorkflowTemplate template]
    (-> this (.instantiateInlineWorkflowTemplateAsync parent template)))
  ([^WorkflowTemplateServiceClient this ^com.google.cloud.dataproc.v1.InstantiateInlineWorkflowTemplateRequest request]
