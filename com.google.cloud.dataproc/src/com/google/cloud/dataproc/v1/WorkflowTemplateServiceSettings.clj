(ns com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (WorkflowTemplateServiceSettings/newBuilder client-context))
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings$Builder []
    (WorkflowTemplateServiceSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStubSettings`

  returns: `com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings [^com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStubSettings stub]
...
(defn instantiate-workflow-template-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dataproc.v1.InstantiateWorkflowTemplateRequest,com.google.longrunning.Operation>`"
...
(defn delete-workflow-template-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dataproc.v1.DeleteWorkflowTemplateRequest,com.google.protobuf.Empty>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^WorkflowTemplateServiceSettings this]
...
(defn instantiate-inline-workflow-template-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1.InstantiateInlineWorkflowTemplateRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1.WorkflowMetadata>`"
...
(defn list-workflow-templates-settings
  ...
  returns: `com.google.api.gax.rpc.PagedCallSettings<com.google.cloud.dataproc.v1.ListWorkflowTemplatesRequest,com.google.cloud.dataproc.v1.ListWorkflowTemplatesResponse,com.google.cloud.dataproc.v1.WorkflowTemplateServiceClient$ListWorkflowTemplatesPagedResponse>`"
...
(defn create-workflow-template-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dataproc.v1.CreateWorkflowTemplateRequest,com.google.cloud.dataproc.v1.WorkflowTemplate>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^WorkflowTemplateServiceSettings this]
...
(defn instantiate-workflow-template-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1.InstantiateWorkflowTemplateRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1.WorkflowMetadata>`"
  ([^WorkflowTemplateServiceSettings this]
...
(defn update-workflow-template-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dataproc.v1.UpdateWorkflowTemplateRequest,com.google.cloud.dataproc.v1.WorkflowTemplate>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^WorkflowTemplateServiceSettings this]
...
(defn get-workflow-template-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dataproc.v1.GetWorkflowTemplateRequest,com.google.cloud.dataproc.v1.WorkflowTemplate>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^WorkflowTemplateServiceSettings this]
...
(defn instantiate-inline-workflow-template-settings
  ...
  returns: `com.google.api.gax.rpc.UnaryCallSettings<com.google.cloud.dataproc.v1.InstantiateInlineWorkflowTemplateRequest,com.google.longrunning.Operation>`"
  (^com.google.api.gax.rpc.UnaryCallSettings [^WorkflowTemplateServiceSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings$Builder`"
  (^com.google.cloud.dataproc.v1.WorkflowTemplateServiceSettings$Builder [^WorkflowTemplateServiceSettings this]
    (-> this (.toBuilder))))
