(ns com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStubSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStubSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
...
(defn instantiate-inline-workflow-template-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1.InstantiateInlineWorkflowTemplateRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1.WorkflowMetadata>`"
  ([^WorkflowTemplateServiceStubSettings this]
...
(defn instantiate-workflow-template-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1.InstantiateWorkflowTemplateRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1.WorkflowMetadata>`"
  ([^WorkflowTemplateServiceStubSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStubSettings$Builder`"
  (^com.google.cloud.dataproc.v1.stub.WorkflowTemplateServiceStubSettings$Builder [^WorkflowTemplateServiceStubSettings this]
    (-> this (.toBuilder))))
