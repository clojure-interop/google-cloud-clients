(ns com.google.cloud.dataproc.v1beta2.ClusterControllerSettings
...
(defn *new-builder
  ...
  (^com.google.cloud.dataproc.v1beta2.ClusterControllerSettings$Builder [^com.google.api.gax.rpc.ClientContext client-context]
    (ClusterControllerSettings/newBuilder client-context))
  (^com.google.cloud.dataproc.v1beta2.ClusterControllerSettings$Builder []
    (ClusterControllerSettings/newBuilder )))
...
(defn *create
  "stub - `com.google.cloud.dataproc.v1beta2.stub.ClusterControllerStubSettings`

  returns: `com.google.cloud.dataproc.v1beta2.ClusterControllerSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dataproc.v1beta2.ClusterControllerSettings [^com.google.cloud.dataproc.v1beta2.stub.ClusterControllerStubSettings stub]
...
(defn create-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1beta2.CreateClusterRequest,com.google.cloud.dataproc.v1beta2.Cluster,com.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>`"
...
(defn delete-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1beta2.DeleteClusterRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>`"
  ([^ClusterControllerSettings this]
...
(defn diagnose-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1beta2.DiagnoseClusterRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1beta2.DiagnoseClusterResults>`"
  ([^ClusterControllerSettings this]
...
(defn update-cluster-operation-settings
  ...
  returns: `(value="The surface for long-running operations is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings<com.google.cloud.dataproc.v1beta2.UpdateClusterRequest,com.google.cloud.dataproc.v1beta2.Cluster,com.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>`"
  ([^ClusterControllerSettings this]
...
(defn to-builder
  ...
  returns: `com.google.cloud.dataproc.v1beta2.ClusterControllerSettings$Builder`"
  (^com.google.cloud.dataproc.v1beta2.ClusterControllerSettings$Builder [^ClusterControllerSettings this]
    (-> this (.toBuilder))))
