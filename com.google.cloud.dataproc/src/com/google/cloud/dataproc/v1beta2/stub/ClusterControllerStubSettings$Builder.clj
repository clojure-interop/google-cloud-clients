(ns com.google.cloud.dataproc.v1beta2.stub.ClusterControllerStubSettings$Builder
  "Builder for ClusterControllerStubSettings."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dataproc.v1beta2.stub ClusterControllerStubSettings$Builder]))
...
(defn apply-to-all-unary-methods
  ...
  (^com.google.cloud.dataproc.v1beta2.stub.ClusterControllerStubSettings$Builder [^ClusterControllerStubSettings$Builder this ^com.google.api.core.ApiFunction settings-updater]
    (-> this (.applyToAllUnaryMethods settings-updater))))

(defn create-cluster-operation-settings
  "Returns the builder for the settings used for calls to createCluster.

  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1beta2.CreateClusterRequest,com.google.cloud.dataproc.v1beta2.Cluster,com.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>`"
...
(defn delete-cluster-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1beta2.DeleteClusterRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>`"
  ([^ClusterControllerStubSettings$Builder this]
...
(defn diagnose-cluster-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1beta2.DiagnoseClusterRequest,com.google.protobuf.Empty,com.google.cloud.dataproc.v1beta2.DiagnoseClusterResults>`"
  ([^ClusterControllerStubSettings$Builder this]
    (-> this (.diagnoseClusterOperationSettings))))

(defn build
  "returns: `com.google.cloud.dataproc.v1beta2.stub.ClusterControllerStubSettings`

  throws: java.io.IOException"
  (^com.google.cloud.dataproc.v1beta2.stub.ClusterControllerStubSettings [^ClusterControllerStubSettings$Builder this]
    (-> this (.build))))
...
(defn update-cluster-operation-settings
  ...
  returns: `(value="The surface for use by generated code is not stable yet and may change in the future.")  com.google.api.gax.rpc.OperationCallSettings.Builder<com.google.cloud.dataproc.v1beta2.UpdateClusterRequest,com.google.cloud.dataproc.v1beta2.Cluster,com.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>`"
  ([^ClusterControllerStubSettings$Builder this]
