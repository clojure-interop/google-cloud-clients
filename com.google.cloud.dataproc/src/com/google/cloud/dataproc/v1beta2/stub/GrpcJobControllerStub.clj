(ns com.google.cloud.dataproc.v1beta2.stub.GrpcJobControllerStub
  "gRPC stub implementation for Google Cloud Dataproc API.

  This class is for advanced usage and reflects the underlying API directly."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.dataproc.v1beta2.stub GrpcJobControllerStub]))

(defn *create
  "client-context - `com.google.api.gax.rpc.ClientContext`
  callable-factory - `com.google.api.gax.grpc.GrpcStubCallableFactory`

  returns: `com.google.cloud.dataproc.v1beta2.stub.GrpcJobControllerStub`

  throws: java.io.IOException"
  (^com.google.cloud.dataproc.v1beta2.stub.GrpcJobControllerStub [^com.google.api.gax.rpc.ClientContext client-context ^com.google.api.gax.grpc.GrpcStubCallableFactory callable-factory]
    (GrpcJobControllerStub/create client-context callable-factory))
  (^com.google.cloud.dataproc.v1beta2.stub.GrpcJobControllerStub [^com.google.cloud.dataproc.v1beta2.stub.JobControllerStubSettings settings]
