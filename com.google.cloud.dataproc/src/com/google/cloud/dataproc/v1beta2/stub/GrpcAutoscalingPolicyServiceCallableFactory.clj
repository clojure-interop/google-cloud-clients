(ns com.google.cloud.dataproc.v1beta2.stub.GrpcAutoscalingPolicyServiceCallableFactory
...
(defn ->grpc-autoscaling-policy-service-callable-factory
  "Constructor."
  (^GrpcAutoscalingPolicyServiceCallableFactory []
    (new GrpcAutoscalingPolicyServiceCallableFactory )))
...
(defn create-unary-callable
  ...
  ([^GrpcAutoscalingPolicyServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-paged-callable
  ...
  ([^GrpcAutoscalingPolicyServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^GrpcAutoscalingPolicyServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^GrpcAutoscalingPolicyServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.longrunning.stub.OperationsStub operations-stub]
...
(defn create-bidi-streaming-callable
  ...
  ([^GrpcAutoscalingPolicyServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.StreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-server-streaming-callable
  ...
  ([^GrpcAutoscalingPolicyServiceCallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.ServerStreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
