(ns com.google.cloud.webrisk.v1beta1.stub.GrpcWebRiskServiceV1Beta1CallableFactory
  "gRPC callable factory implementation for Web Risk API.

  This class is for advanced usage."
  (:refer-clojure :only [require comment defn ->])
  (:import [com.google.cloud.webrisk.v1beta1.stub GrpcWebRiskServiceV1Beta1CallableFactory]))

(defn ->grpc-web-risk-service-v-1-beta-1-callable-factory
  "Constructor."
  (^GrpcWebRiskServiceV1Beta1CallableFactory []
    (new GrpcWebRiskServiceV1Beta1CallableFactory )))
...
(defn create-unary-callable
  ...
  ([^GrpcWebRiskServiceV1Beta1CallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.UnaryCallSettings call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-paged-callable
  ...
  ([^GrpcWebRiskServiceV1Beta1CallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.PagedCallSettings paged-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-batching-callable
  ...
  returns: `<RequestT,ResponseT> com.google.api.gax.rpc.UnaryCallable<RequestT,ResponseT>`"
  ([^GrpcWebRiskServiceV1Beta1CallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.BatchingCallSettings batching-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-operation-callable
  ...
  ([^GrpcWebRiskServiceV1Beta1CallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.OperationCallSettings operation-call-settings ^com.google.api.gax.rpc.ClientContext client-context ^com.google.longrunning.stub.OperationsStub operations-stub]
...
(defn create-bidi-streaming-callable
  ...
  ([^GrpcWebRiskServiceV1Beta1CallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.StreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
...
(defn create-server-streaming-callable
  ...
  ([^GrpcWebRiskServiceV1Beta1CallableFactory this ^com.google.api.gax.grpc.GrpcCallSettings grpc-call-settings ^com.google.api.gax.rpc.ServerStreamingCallSettings streaming-call-settings ^com.google.api.gax.rpc.ClientContext client-context]
